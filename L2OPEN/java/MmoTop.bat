...
java -server %java_settings% %java_opts% -cp ../../kernel/l2openserver.jar;./lib/tools.jar;../../../lib/tools-game.jar;./lib/l2openserver.jar;./lib/*; l2open.gameserver.instancemanager.MMOTopManager
