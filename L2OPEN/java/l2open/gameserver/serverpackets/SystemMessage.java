...
public class SystemMessage extends L2GameServerPacket
{
	...
	public GCArray<Arg> args = new GCArray<Arg>();
	...
	public static final int YOU_HAVE_BEEN_PLAYING_FOR_S1_HOUR_PLEASE_CONSIDER_TAKING_A_BREAK = 764; // Вы играете уже $s1 ч. Советуем Вам отдохнуть.
	...
	public static final int A_USER_CURRENTLY_PARTICIPATING_IN_THE_OLYMPIAD_CANNOT_SEND_PARTY_AND_FRIEND_INVITATIONS = 3094; // Нельзя пригласить в группу или добавить в друзья игрока, который участвует в Олимпиаде.
	public static final int THE_CERTIFICATION_FAILED_BECAUSE_YOU_DID_NOT_ENTER_A_VALID_CERTIFICATION_NUMBER_OR_YOU_DID_NOT = 3095; // Вы ввели неверный идентификационный номер или не ввели его вовсе. Если не пройти идентификацию 3 раза подряд, вход с данного аккаунта будет запрещен на 30 минут.
	public static final int DUE_TO_PROBLEMS_WITH_COMMUNICATIONS_OUR_TELEPHONE_CERTIFICATION_SERVICE_IS_CURRENTLY_UNAVAILABLE = 3096; // Из-за неполадок телефонной службы временно нельзя пройти идентификацию по телефону. Повторите попытку позже.
	public static final int DUE_TO_PROBLEMS_WITH_COMMUNICATIONS_TELEPHONE_SIGNALS_ARE_BEING_DELAYED_PLEASE_TRY_AGAIN_LATER = 3097; // Из-за неполадок телефонной службы входящие звонки временно не работают. Повторите попытку позже.
	public static final int THE_CERTIFICATION_FAILED_BECAUSE_THE_LINE_WAS_BUSY_OR_THE_CALL_WAS_NOT_RECEIVED_PLEASE_TRY_AGAIN = 3098; // Идентификация не удалась из-за того, что телефон занят или никто не берет трубку. Повторите попытку позже.
	public static final int THE_TELEPHONE_CERTIFICATION_SERVICE_SUBSCRIPTION_NUMBER_IS_EXPIRED_OR_INCORRECT_PLEASE_CHECK_THE = 3099; // Неверный номер, указанный при регистрации сервиса "Идентификация по телефону". Проверьте регистрационную информацию (l2.ru>Центр безопасности>Сервис идентификации по телефону).
	public static final int THE_TELEPHONE_CERTIFICATION_SERVICE_IS_CURRENTLY_BEING_CHECKED_PLEASE_TRY_AGAIN_LATER = 3100; // Сервис идентификации по телефону закрыт на профилактические работы. Повторите попытку позже.
	public static final int DUE_TO_HEAVY_VOLUME_THE_TELEPHONE_CERTIFICATION_SERVICE_CANNOT_BE_USED_AT_THIS_TIME_PLEASE_TRY = 3101; // Сервис идентификации по телефону перегружен. Повторите попытку позже.
	public static final int THE_TELEPHONE_CERTIFICATION_SERVICE_USE_PERIOD_HAS_EXPIRED_SO_GAME_PLAY_HAS_BEEN_BLOCKED_PLEASE = 3102; // Время использования сервиса идентификации по телефону истекло, и запуск игры запрещен. Проверьте настройки ограничений на запуск игры. (l2.ru>Центр безопасности>Сервис идентификации по телефону)
	public static final int THE_TELEPHONE_CERTIFICATION_FAILED_3_TIMES_IN_A_ROW_SO_GAME_PLAY_HAS_BEEN_BLOCKED_FOR_30_MINUTES = 3103; // Идентификация по телефону не удалась 3 раза подряд, и вход в игру запрещен на 30 минут. Повторите попытку позже.
	public static final int THE_NUMBER_OF_USES_OF_THE_DAILY_TELEPHONE_CERTIFICATION_SERVICE_HAS_BEEN_EXCEEDED = 3104; // Вы превысили суточный лимит на использование сервиса идентификации по телефону.
	public static final int TELEPHONE_CERTIFICATION_IS_ALREADY_UNDERWAY_PLEASE_TRY_AGAIN_LATER = 3105; // Идентификация по телефону уже проводится. Повторите попытку позже.
	public static final int TELEPHONE_CERTIFICATION_IS_UNDERWAY = 3106; // Ведется идентификация по телефону.
	public static final int ONE_MOMENT_PLEASE = 3107; // Пожалуйста, подождите.
	public static final int YOU_ARE_NO_LONGER_PROTECTED_FROM_AGGRESSIVE_MONSTERS = 3108; // Теперь Вы можете направить агрессию монстра на себя.
	public static final int S1_HAS_ACHIEVED_S2_WINS_IN_A_ROW_IN_JACK_S_GAME = 3109; // Персонаж $s1 победил в Игре Джека $s2 раз подряд.
	public static final int IN_REWARD_FOR_S2_WINS_IN_A_ROW_S1_HAS_RECEIVED_S4_OF_S3S = 3110; // Персонаж $s1 за $s2 побед получает $s3 в количестве $s4 шт.
	public static final int WORLD__S1_WINS_IN_A_ROW_S2_PPL = 3111; // Мир: $s1 побед подряд ($s2 чел.)
	public static final int MY_RECORD__S1_WINS_IN_A_ROW = 3112; // Мой рекорд: $s1 побед подряд
	public static final int WORLD__BELOW_4_WINS_IN_A_ROW = 3113; // Мир: меньше 4 побед подряд
	public static final int MY_RECORD__BELOW_4_WINS_IN_A_ROW = 3114; // Мой рекорд: меньше 4 побед подряд
	public static final int THIS_IS_THE_HALLOWEEN_EVENT_PERIOD = 3115; // Период проведения ивента Хэллоуина.
	public static final int NO_RECORD_OF_10_OR_MORE_WINS_IN_A_ROW = 3116; // Нет рекордов выше 10 побед подряд.
	public static final int THE_GIFT_S_REMAINING_RESUPPLY_TIME_IS_S1_MINUTES_S2_SECONDS_IF_YOU_RESUMMON_THE_AGATHION_AT_THE = 3171; // До получения подарка осталось: $s1 мин. $s2 сек. (Если призвать Агатиона еще раз, время может увеличиться на 30 мин.)
	public static final int THE_GIFT_S_REMAINING_RESUPPLY_TIME_IS_S1_SECONDS_IF_YOU_RESUMMON_THE_AGATHION_AT_THE_GIFT_SUPPLY = 3172; // До получения подарка осталось: $s1 сек. (Если призвать Агатиона еще раз, время может увеличиться на 30 мин.)
	public static final int YOU_CURRENTLY_DO_NOT_HAVE_ANY_RECOMMENDATIONS = 3206; // В настоящий момент у Вас нет рекомендаций.
	public static final int YOU_OBTAINED_S1_RECOMMENDATIONS = 3207; // Рекомендаций получено: $s1
	public static final int S1_SUCCESSFULLY_ADDED_TO_CONTACT_LIST = 3214;
	public static final int NAME_S1_NOT_EXIST_TRY_ANOTHER_NAME = 3215;
	public static final int NAME_ALREADY_EXIST_ON_CONTACT_LIST = 3216;
	public static final int NAME_NOT_REGISTERED_ON_CONTACT_LIST = 3217;
	public static final int S1_SUCCESFULLY_DELETED_FROM_CONTACT_LIST = 3219;
	public static final int CANNOT_ADD_YOUR_NAME_ON_CONTACT_LIST = 3221;
	public static final int MP_BECAME_0_ARCANE_SHIELD_DISAPPEARING = 3256;
	public static final int YOU_HAVE_ACQUIRED_S1_EXP_BONUS_S2_AND_S3_SP_BONUS_S4 = 3259;
	public static final int THE_LOVERS__JUBILEE_HAS_BEGUN = 6037; // Период ивента Дух Розы.
	public static final int YOU_CAN_USE_EVANGELIST_MARK__EVANGELIST_ON_OFF_IS_USED_TO_TOGGLE = 6038; // Теперь Вы можете ставить знак Евангелиста. (Вкл./Выкл. знак можно с помощью команды /eva on/off)
	public static final int YOU_HAVE_COMPLETED_THE_INITIAL_LEVEL_CONGRATULATIONS = 6039; // Поздравляем! Вы завершили этап посвящения.
	public static final int PLEASE_TYPE__ON_OFF__AFTER_THE_COMMAND = 6040; // Пожалуйста, напишите on/off после команды.
	public static final int THIS_IS_THE_APRIL_FOOLS__DAY_EVENT_PERIOD = 6041; // Период ивента Дня Смеха.
	public static final int THE_SKILL_HAS_BEEN_CANCELED_BECAUSE_YOU_HAVE_INSUFFICIENT_SOUL_AVATAR_ENERGY = 6042; // Умение отменено из-за недостатка энергии Духовного Аватара.
	public static final int YOUR_ENERGY_CANNOT_BE_REPLENISHED_BECAUSE_THERE_IS_NO_SOUL_AVATAR = 6043; // Нельзя восстановить энергию из-за отсутсвия Духовного Аватара.
	public static final int ENERGY_S_REPLENISHED_AT_THE_SOUL_AVATAR = 6044; // Энергия Духовного Аватара восстановлена на $s.
	public static final int C1_ACQUIRED_APRIL_FOOLS__DAY_SPECIAL_GIFT = 6045; // $c1 получает особый подарок Дня Смеха.
	...
	public static final int WHEN_YOUR_PETS_HUNGER_GAUGE_IS_AT_0_YOU_CANNOT_USE_YOUR_PET = 3212; // Если шкала сытости питомца опустится до 0%, питомца нельзя будет призвать.
	public static final int YOUR_PET_IS_STARVING_AND_WILL_NOT_OBEY_UNTIL_IT_GETS_ITS_FOOD = 3213; //Питомец голоден и не слушает своего хозяина. Накормите его!
	public static final int YOUR_ENERGY_CANNOT_BE_REPLENISHED_BECAUSE_CONDITIONS_ARE_NOT_MET = 6043; // Message: Your energy cannot be replenished because conditions are not met.
	public static final int ENERGY_S1_REPLENISHED = 6044; // Message: Energy $s1 replenished.

	public static final int BECAUSE_C1_WAS_KILLED_BY_A_CLAN_MEMBER_OF_S2_CLAN_REPUTATION_DECREASED_BY_1 = 3811;
	public static final int BECAUSE_A_CLAN_MEMBER_OF_S1_WAS_KILLED_BY_C2_CLAN_REPUTATION_INCREASED_BY_1 = 3812;
	...
	public static final int YOU_CANNOT_EQUIP_S1_WITHOUT_EQUIPPING_A_BROOCH = 4237;
	public static final int THIS_IS_NOT_A_VALID_COMBINATION = 4221;
	...
	public SystemMessage(CustomMessage message)
	{
		this(message.toString());
	}

	public SystemMessage(String address, L2Object player, Object... args) //CustomMessage
	{
		this(new CustomMessage(address, player, args));
	}

	public static SystemMessage obtainItems(int item_id, long count, int enchantLevel)
	{
		if(item_id == 57)
			return new SystemMessage(SystemMessage.YOU_HAVE_EARNED_S1_ADENA).addNumber(count);
		if(count > 1)
			return new SystemMessage(SystemMessage.YOU_HAVE_EARNED_S2_S1S).addItemName(item_id).addNumber(count);
		if(enchantLevel > 0)
			return new SystemMessage(SystemMessage.YOU_HAVE_OBTAINED__S1S2).addNumber(enchantLevel).addItemName(item_id);
		return new SystemMessage(SystemMessage.YOU_HAVE_EARNED_S1).addItemName(item_id);
	}

	public static SystemMessage obtainItems(L2ItemInstance item)
	{
		return obtainItems(item.getItemId(), item.getCount(), item.isEquipable() ? item.getEnchantLevel() : 0);
	}

	public static SystemMessage obtainItemsBy(int item_id, long count, int enchantLevel, String targetName)
	{
		if(count > 1)
			return new SystemMessage(SystemMessage.S1_HAS_OBTAINED_S3_S2).addString(targetName).addItemName(item_id).addNumber(count);
		if(enchantLevel > 0)
			return new SystemMessage(SystemMessage.S1_HAS_OBTAINED__S2S3).addString(targetName).addNumber(enchantLevel).addItemName(item_id);
		return new SystemMessage(SystemMessage.S1_HAS_OBTAINED_S2).addString(targetName).addItemName(item_id);
	}

	public static SystemMessage obtainItemsBy(L2ItemInstance item, String targetName)
	{
		return obtainItemsBy(item.getItemId(), item.getCount(), item.isEquipable() ? item.getEnchantLevel() : 0, targetName);
	}

	public static SystemMessage removeItems(int item_id, long count)
	{
		if(item_id == 57)
			return new SystemMessage(SystemMessage.S1_ADENA_DISAPPEARED).addNumber(count);
		if(count > 1)
			return new SystemMessage(SystemMessage.S2_S1_HAS_DISAPPEARED).addItemName(item_id).addNumber(count);
		return new SystemMessage(SystemMessage.S1_HAS_DISAPPEARED).addItemName(item_id);
	}

	public static SystemMessage removeItems(L2ItemInstance item)
	{
	 ...
	 */
	public SystemMessage addName(L2Character cha)
	{
        if(cha == null)
		...
		if(cha.isDoor())
			return addDoorName(((L2DoorInstance) cha).getDoorId());

		if(cha.getNpcId() <= 0 || cha.getDisplayId() != 0)
			return addString(cha.getEventMaster() != null ? cha.getEventMaster().getCharName(cha) : cha.getName());
    ...
    public SystemMessage addSystemString(int id ) 
	{
        args.add(new Arg(TYPE_SYSTEM_STRING, new Integer(id)));
        return this;
    }

    public SystemMessage addElementName(int id) 
	{
        args.add(new Arg(TYPE_ELEMENT_NAME, new Integer(id)));
        return this;
    }
	...
	public SystemMessage addUnk8(int unk1, int unk2, int unk3)
	{
		args.add(new Arg(TYPE_UNKNOWN_8, new int[] { unk1, unk2, unk3 }));
		return this;
	}

	public SystemMessage addDamage(L2Character targetid, L2Character attakerid, long damage)
	{
		if(ConfigValue.EnableLindvior)
			args.add(new Arg(TYPE_DAMAGE, new int[]{targetid.getObjectId(), attakerid.getObjectId(), (int)damage}));
		return this;
	}
	...
	protected final void writeImpl()
	{
		...
		writeD(_messageId);
		writeD(args.size());
		//_log.info("-------------------------------------\nSystemMessage: id="+_messageId+" size="+args.size());
		for(Arg e : args)
		{
			writeD(e.type);
		...
		//	_log.info("SystemMessage: type="+e.type+" size="+args.size());
		}
	}
