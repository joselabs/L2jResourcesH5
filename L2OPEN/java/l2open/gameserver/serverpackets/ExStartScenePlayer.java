...
public class ExStartScenePlayer extends L2GameServerPacket
{
	...
	public static final int SCENE_SC_BOSS_FREYA_OPENING = 15;
	public static final int SCENE_SC_BOSS_FREYA_PHASECH_A = 16;
	public static final int SCENE_SC_BOSS_FREYA_PHASECH_B = 17;
	public static final int SCENE_SC_BOSS_KEGOR_INTRUSION = 18;
	public static final int SCENE_SC_BOSS_FREYA_ENDING_A = 19;
	public static final int SCENE_SC_BOSS_FREYA_ENDING_B = 20;
	public static final int SCENE_SC_BOSS_FREYA_FORCED_DEFEAT = 21;
	public static final int SCENE_SC_BOSS_FREYA_DEFEAT = 22;
