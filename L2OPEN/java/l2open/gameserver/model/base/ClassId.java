...
public enum ClassId
{
	...
	warlock(14, true, Race.human, wizard, null, 3, true, ClassType2.Summoner),
	...
	elementalSummoner(28, true, Race.elf, elvenWizard, null, 3, true, ClassType2.Summoner),
	...
	phantomSummoner(41, true, Race.darkelf, darkWizard, null, 3, true, ClassType2.Summoner),
	...
	arcanaLord(96, true, Race.human, warlock, null, 4, true, ClassType2.Summoner),
	...
	elementalMaster(104, true, Race.elf, elementalSummoner, null, 4, true, ClassType2.Summoner),
	...
	spectralMaster(111, true, Race.darkelf, phantomSummoner, null, 4, true, ClassType2.Summoner),
	...
	private boolean _isSummoner;

	/**
	 * Constructor<?> of ClassId.<BR><BR>
	 */
	private ClassId(int id, boolean isMage, Race race, ClassId parent, ClassId parent2, int level, boolean sumonner, ClassType2 classType2)
	{
		_id = id;
		_isMage = isMage;
		_race = race;
	...
	{ 
		this(id, isMage, race, parent, parent2, level, false, classType2);
	}
	/**
	...
	public final boolean isAllowAttributeTransfer() 
	{ 
		return _isSummoner && _level > 2; 
	}
