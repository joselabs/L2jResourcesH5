...
public class Wedding implements IVoicedCommandHandler
{
	...
	public boolean divorce(L2PcInstance activeChar)
	{
		...
		if (activeChar.isMarried())
		{
			...
			AdenaAmount = (activeChar.getAdena() / 100) * WeddingConfigs.L2JMOD_WEDDING_DIVORCE_COSTS;
	...
	public boolean engage(L2PcInstance activeChar)
	{
		...
		else if (activeChar.getPartnerId() != 0)
		{
			...
			if (WeddingConfigs.L2JMOD_WEDDING_PUNISH_INFIDELITY)
			{
	...
	public boolean goToLove(L2PcInstance activeChar)
	{
		...
		final int teleportTimer = WeddingConfigs.L2JMOD_WEDDING_TELEPORT_DURATION * 1000;
		activeChar.sendMessage("After " + (teleportTimer / 60000) + " min. you will be teleported to your partner.");
		activeChar.getInventory().reduceAdena("Wedding", WeddingConfigs.L2JMOD_WEDDING_TELEPORT_PRICE, activeChar, null);
