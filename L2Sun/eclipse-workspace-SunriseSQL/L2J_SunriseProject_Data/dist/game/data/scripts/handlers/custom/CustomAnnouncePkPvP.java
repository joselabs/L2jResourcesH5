...
public class CustomAnnouncePkPvP
{
	...
	{
		if (PvpAnnounceConfigs.ANNOUNCE_PK_PVP)
		{
	...
	private Object OnPlayerPvPKill(OnPlayerPvPKill event)
	{
		...
		String msg = PvpAnnounceConfigs.ANNOUNCE_PVP_MSG;
		if (player.getPvpFlag() == 0)
		{
			msg = PvpAnnounceConfigs.ANNOUNCE_PK_MSG;
		}
		msg = msg.replace("$killer", pk.getName()).replace("$target", player.getName());
		if (PvpAnnounceConfigs.ANNOUNCE_PK_PVP_NORMAL_MESSAGE)
		{
