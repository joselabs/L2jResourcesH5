...
public final class Wedding extends AbstractNpcAI
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (event)
		{
			...
			case "accept":
			{
				...
				else if ((player.getAdena() < WeddingConfigs.L2JMOD_WEDDING_PRICE) || (partner.getAdena() < WeddingConfigs.L2JMOD_WEDDING_PRICE))
				{
					htmltext = sendHtml(partner, "Adena.html", "%fee%", String.valueOf(WeddingConfigs.L2JMOD_WEDDING_PRICE));
				}
				else
				{
					player.reduceAdena("Wedding", WeddingConfigs.L2JMOD_WEDDING_PRICE, player.getLastFolkNPC(), true);
					partner.reduceAdena("Wedding", WeddingConfigs.L2JMOD_WEDDING_PRICE, player.getLastFolkNPC(), true);
	...
	public String onFirstTalk(L2Npc npc, L2PcInstance player)
	{
		...
		return htmltext.replaceAll("%fee%", String.valueOf(WeddingConfigs.L2JMOD_WEDDING_PRICE));
	}
	...
	{
		if (WeddingConfigs.L2JMOD_WEDDING_FORMALWEAR)
		{
