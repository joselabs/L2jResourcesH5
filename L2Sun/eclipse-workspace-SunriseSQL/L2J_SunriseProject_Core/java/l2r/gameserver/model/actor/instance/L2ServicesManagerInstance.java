...
public final class L2ServicesManagerInstance extends L2NpcInstance
{
	...
	public void onBypassFeedback(final L2PcInstance player, String command)
	{
		...
		else if (actualCommand.equalsIgnoreCase("createacademy"))
		{
			...
			L2VillageMasterInstance.createSubPledge(player, cmdParams, null, ClanUnitTypes.SUBUNIT_ACADEMY.getId(), 5);
		}
		...
		else if (actualCommand.equalsIgnoreCase("createroyal"))
		{
			...
			L2VillageMasterInstance.createSubPledge(player, cmdParams, cmdParams2, ClanUnitTypes.SUBUNIT_ROYAL1.getId(), 6);
		}
		else if (actualCommand.equalsIgnoreCase("createknight"))
		{
			...
			L2VillageMasterInstance.createSubPledge(player, cmdParams, cmdParams2, ClanUnitTypes.SUBUNIT_KNIGHT1.getId(), 7);
		}
