...
public class PcInventory extends Inventory
{
	...
	@Override
	public boolean destroyItemByObjectId(String process, int objectId, long count, L2PcInstance owner, Object reference)
	{
		...
		final L2ItemInstance destroyedItem = destroyItem(process, item, count, owner, reference);
		return destroyedItem != null;
	}
