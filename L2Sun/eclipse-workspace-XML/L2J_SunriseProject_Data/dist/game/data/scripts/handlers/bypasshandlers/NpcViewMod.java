			...
			else if (dropItem instanceof GroupedGeneralDropItem)
			{
				...
				else
				{
					...
					for (GeneralDropItem generalDropItem : normalized.getItems())
					{
						...
						MinMax minMax = getPreciseMinMax((generalDropItem.getChance() * normalized.getChance()) / 100, generalDropItem.getMin(npc), generalDropItem.getMax(npc), generalDropItem.isPreciseCalculated());
						...
						sb.append(chanceFormat.format(Math.min((generalDropItem.getChance() * normalized.getChance()) / 100, 100)));
