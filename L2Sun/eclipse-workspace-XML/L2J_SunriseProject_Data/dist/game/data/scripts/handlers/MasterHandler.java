...
import handlers.bypasshandlers.clan.AssignSubplLeader;
import handlers.bypasshandlers.clan.ChangeClanLeader;
import handlers.bypasshandlers.clan.ClanReinforceSubunit;
import handlers.bypasshandlers.clan.ClanRenameSubunit;
import handlers.bypasshandlers.clan.CreateAcademy;
import handlers.bypasshandlers.clan.CreateAlly;
import handlers.bypasshandlers.clan.CreateClan;
import handlers.bypasshandlers.clan.CreateKnight;
import handlers.bypasshandlers.clan.CreateRoyal;
import handlers.bypasshandlers.clan.DissolveAlly;
import handlers.bypasshandlers.clan.DissolveClan;
import handlers.bypasshandlers.clan.IncreaseClanLevel;
import handlers.bypasshandlers.clan.LearnClanSkills;
import handlers.bypasshandlers.clan.RecoverClan;
...
public class MasterHandler
{
	...
	private static final Class<?>[] BYPASS_HANDLERS =
	{
		...
		// vGodFather
		AssignSubplLeader.class,
		ChangeClanLeader.class,
		ClanReinforceSubunit.class,
		ClanRenameSubunit.class,
		CreateAcademy.class,
		CreateAlly.class,
		CreateClan.class,
		CreateKnight.class,
		...
		DissolveAlly.class,
		DissolveClan.class,
		IncreaseClanLevel.class,
		LearnClanSkills.class,
		RecoverClan.class,
	};
