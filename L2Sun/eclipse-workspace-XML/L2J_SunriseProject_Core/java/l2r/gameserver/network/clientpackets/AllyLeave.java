...
public final class AllyLeave extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		clan.setAllyPenaltyExpiryTime(currentTime + (Config.ALT_ALLY_JOIN_DAYS_WHEN_LEAVED * 86400000L), AllyPenaltyTypes.PENALTY_TYPE_CLAN_LEAVED.getId()); // 24*60*60*1000 = 86400000
		clan.updateClanInDB();
