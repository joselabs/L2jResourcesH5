...
public class EnterWorld extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (ScreenWelcomeMessageConfigs.WELCOME_MESSAGE_ENABLED)
		{
			activeChar.sendPacket(new ExShowScreenMessage(ScreenWelcomeMessageConfigs.WELCOME_MESSAGE_TEXT, ScreenWelcomeMessageConfigs.WELCOME_MESSAGE_TIME));
		}
