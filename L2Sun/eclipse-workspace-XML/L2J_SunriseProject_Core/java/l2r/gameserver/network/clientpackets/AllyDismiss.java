...
public final class AllyDismiss extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		leaderClan.setAllyPenaltyExpiryTime(currentTime + (Config.ALT_ACCEPT_CLAN_DAYS_WHEN_DISMISSED * 86400000L), AllyPenaltyTypes.PENALTY_TYPE_DISMISS_CLAN.getId()); // 24*60*60*1000 = 86400000
		leaderClan.updateClanInDB();
		
		clan.setAllyId(0);
		clan.setAllyName(null);
		clan.changeAllyCrest(0, true);
		clan.setAllyPenaltyExpiryTime(currentTime + (Config.ALT_ALLY_JOIN_DAYS_WHEN_DISMISSED * 86400000L), AllyPenaltyTypes.PENALTY_TYPE_CLAN_DISMISSED.getId()); // 24*60*60*1000 = 86400000
		clan.updateClanInDB();
