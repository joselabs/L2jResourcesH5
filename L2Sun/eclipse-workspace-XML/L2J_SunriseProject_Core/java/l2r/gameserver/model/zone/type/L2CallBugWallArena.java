	...
	protected void onEnter(L2Character character)
	{
		...
		if (character instanceof L2PcInstance)
		{
			...
			while (true)
			{
				...
				final Location loc = GeoData.getInstance().moveCheck(character.getLocation().getX() + Rnd.get(-100, +100), character.getLocation().getY() + Rnd.get(-100, +100), character.getLocation().getZ(), character.getLocation().getX() + Rnd.get(-100, 100), character.getLocation().getY() + Rnd.get(-100, 100), character.getLocation().getZ(), character.getGeoIndex());
