...
import gr.sr.autoFarm.AutofarmBBSManager;
...
public class BoardsManager
{
	public void handleCommands(L2GameClient client, String command)
	{
		...
		if (command.startsWith(AutofarmBBSManager.getInstance()._bypass))
		{
			AutofarmBBSManager.getInstance().cbByPass(command, activeChar);
			return;
		}
