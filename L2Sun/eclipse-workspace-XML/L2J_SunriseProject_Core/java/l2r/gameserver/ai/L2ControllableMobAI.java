		...
		else
		{
			...
			if (((L2Npc) _actor).getTemplate().getClans() != null)
			{
				...
				for (L2Object obj : objs)
				{
					...
					if (_actor.isInsideRadius(npc, npc.getTemplate().getClanHelpRange(), false, true) && (Math.abs(getInteractionTarget().getZ() - npc.getZ()) < 200))
					{
			...
			double dist2 = _actor.calculateDistance(getInteractionTarget(), false, true);
