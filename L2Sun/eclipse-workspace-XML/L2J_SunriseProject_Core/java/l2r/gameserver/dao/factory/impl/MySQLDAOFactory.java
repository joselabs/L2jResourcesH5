...
import l2r.gameserver.dao.impl.mysql.FriendDAOMySQLImpl;
...
import l2r.gameserver.dao.impl.mysql.PetSkillSaveDAOMySQLImpl;
import l2r.gameserver.dao.impl.mysql.PlayerSkillSaveDAOMySQLImpl;
...
import l2r.gameserver.dao.impl.mysql.ServitorSkillSaveDAOMySQLImpl;
...
enum MySQLDAOFactory implements IDAOFactory
{
	...
	private final PetSkillSaveDAO petSkillSaveDAO = new PetSkillSaveDAOMySQLImpl();
