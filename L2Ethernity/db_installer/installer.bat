...
@Echo off
TITLE Eternity-World Database Installer
cls
...
echo  - MySQL...       ok
echo ======================================================================
echo Eternity Server is ready for installation.
...
echo ===========================================================================
echo #									  #
echo #      Server Compiled - Thanks for choising Eternity Services            #
echo #		             www.l2jeternity.com			  #
echo #									  #
echo ===========================================================================
pause > nul