...
public class PremiumBuffer extends Quest
{
	...
	private String rebuildMainHtml(QuestState st)
	{
		...
		final String[] TRS =
		{
		        "<tr><td height=25>", "</td>", "<td height=25>", "</td></tr>"
		};
	...
	private String viewAllBuffs(String type, String typeName, String page)
	{
		...
		for (int ii = 1; ii <= pc; ++ii)
		{
			...
			{
				HTML_MESSAGE += "<td width=" + width + "><button value=\"" + pageName + "" + ii + "\" action=\"bypass -h Quest " + QUEST_LOADING_INFO + " edit_premium_buff_list " + type + " " + typeName + " " + ii + "\" width=" + width + " height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>";
			}
		}
