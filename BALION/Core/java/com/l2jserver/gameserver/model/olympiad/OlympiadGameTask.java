...
public final class OlympiadGameTask implements Runnable
{
	...
	/**
	 * Second stage: check for defaulted, port players to arena, announce game. Returns true if no participants defaulted.
	 */
	...
	/**
	 * Fourth stage: last checks, remove buffers, start competition itself. Returns true if all participants online and ready on the stadium.
	 */
