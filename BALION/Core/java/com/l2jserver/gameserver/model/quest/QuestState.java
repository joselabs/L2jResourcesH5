...
public final class QuestState
{
	...
	{
		String text = HtmCache.getInstance().getHtm(getPlayer().getHtmlPrefix(), "data/scripts/quests/Q00255_Tutorial/" + html);
		if (text == null)
		{
			_log.warning("missing html page data/scripts/quests/Q00255_Tutorial/" + html);
	...
	public long getQuestItemsCount(int... itemId)
	{
		...
		for (int i : itemId)
		{
			count += Quest.getQuestItemsCount(_player, i);
		}
		return count;
	}
}
