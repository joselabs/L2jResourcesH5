...
public class L2SepulcherMonsterInstance extends L2MonsterInstance
{
	...
	{
		String questId = "Q00620_FourGoblets";
		int cupId = 0;
		int oldBrooch = 7262;
	...
	private class VictimShout implements Runnable
	{
		...
		public void run()
		{
			...
			broadcastPacket(new CreatureSay(getObjectId(), 1, getName(), "Forgive me!!"));
		}
	}
	...
	private class VictimSpawnKeyBox implements Runnable
	{
		...
		public void run()
		{
			...
			broadcastPacket(new CreatureSay(getObjectId(), 1, getName(), "Many thanks for rescue me."));
			if (_victimShout != null)
			{
				_victimShout.cancel(true);
			}
