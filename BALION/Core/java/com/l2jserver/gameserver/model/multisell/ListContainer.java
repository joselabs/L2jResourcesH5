...
public class ListContainer
{
	...
	protected boolean allowBBS = false;
	 ...
	 * @return the allowBBS
	 */
	public boolean isAllowBBS()
	{
		return allowBBS;
	}
	
	/**
	 * @param allowBBS the allowBBS to set
	 */
	public void setAllowBBS(boolean allowBBS)
	{
		this.allowBBS = allowBBS;
	}
}