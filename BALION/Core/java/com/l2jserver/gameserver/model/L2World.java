...
public final class L2World
{
	...
	/** Map dimensions */
	public static final int MAP_MIN_X = (11 - 20) * TILE_SIZE;
	public static final int MAP_MAX_X = (26 - 19) * TILE_SIZE;
	public static final int MAP_MIN_Y = (10 - 18) * TILE_SIZE;
	public static final int MAP_MAX_Y = (26 - 17) * TILE_SIZE;
	...
	private final L2TIntObjectHashMap<L2PcInstance> allPlayers;
	 ...
	 * <BR>
	 * <B>If you have access to player objectId use {@link #getPlayer(int playerObjId)}</B> <BR>
	...
	{
		return allPlayers.values(new L2PcInstance[0]);
	}
}
