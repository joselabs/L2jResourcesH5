		...
		public void run()
		{
			...
			try
			{
				...
				for (int i = 0; i < _numOfBoxes; i++)
				{
					...
					spawn.setXLocation(_arenaCoordinates[_arena][4] + Rnd.get(-400, 400));
					spawn.setYLocation(_arenaCoordinates[_arena][5] + Rnd.get(-400, 400));
					spawn.setZLocation(_zCoord);
					spawn.setAmount(1);
					spawn.setHeading(1);
			...
			if ((_round == 1) || (_round == 2))
			{
				...
				try
				{
					...
					girlSpawn.setXLocation(_arenaCoordinates[_arena][4] + Rnd.get(-400, 400));
					girlSpawn.setYLocation(_arenaCoordinates[_arena][5] + Rnd.get(-400, 400));
					girlSpawn.setZLocation(_zCoord);
