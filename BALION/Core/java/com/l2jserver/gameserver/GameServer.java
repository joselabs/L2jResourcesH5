...
public class GameServer
{
	...
	public GameServer() throws Exception
	{
		...
		printSection("NPCs");
		// NpcPersonalAIData.getInstance(); TODO: NEED IT ?
		...
		try
		{
			_log.info("Loading Server Scripts (script.cfg)");
		...
		if (Config.USE_PREMIUMSERVICE)
		{
			printSection("Premium Account System - Activated");
			PremiumManager.getInstance();
		}
		else
		{
			printSection("Premium Account System - Deactivated");
		}
