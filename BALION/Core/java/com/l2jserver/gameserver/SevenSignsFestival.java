	...
	private class L2DarknessFestival
	{
		...
		protected void festivalInit()
		{
			...
			try
			{
				...
				npcSpawn.setXLocation(_witchSpawn._x);
				npcSpawn.setYLocation(_witchSpawn._y);
				npcSpawn.setZLocation(_witchSpawn._z);
		...
		protected void spawnFestivalMonsters(int respawnDelay, int spawnType)
		{
			...
			for (int[] _npcSpawn : _npcSpawns)
			{
				...
				try
				{
					...
					npcSpawn.setXLocation(currSpawn._x);
					npcSpawn.setYLocation(currSpawn._y);
					npcSpawn.setZLocation(currSpawn._z);
