...
public class L2PcTemplate extends L2CharTemplate
{
	...
	public final double fCollisionHeight_male;
	public final double fCollisionRadius_male;
	...
	public L2PcTemplate(StatsSet set)
	{
		...
		fCollisionRadius_male = set.getDouble("collision_radius");
		fCollisionHeight_male = set.getDouble("collision_height");
