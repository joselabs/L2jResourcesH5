...
public class FourSepulchersManager
{
	...
	private static final String QUEST_ID = "Q00620_FourGoblets";
			...
			try
			{
				...
				switch (i)
				{
					case 31921: // conquerors
						spawnDat.setXLocation(181061);
						spawnDat.setYLocation(-85595);
						spawnDat.setZLocation(-7200);
						spawnDat.setHeading(-32584);
						break;
					case 31922: // emperors
						spawnDat.setXLocation(179292);
						spawnDat.setYLocation(-88981);
						spawnDat.setZLocation(-7200);
						spawnDat.setHeading(-33272);
						break;
					case 31923: // sages
						spawnDat.setXLocation(173202);
						spawnDat.setYLocation(-87004);
						spawnDat.setZLocation(-7200);
						spawnDat.setHeading(-16248);
						break;
					case 31924: // judges
						spawnDat.setXLocation(175606);
						spawnDat.setYLocation(-82853);
						spawnDat.setZLocation(-7200);
						spawnDat.setHeading(-16248);
						break;
				}
		...
		for (int keyNpcId : _keyBoxNpc.keys())
		{
			try
			{
				...
				if (template != null)
				{
					...
					spawnDat.setAmount(1);
					spawnDat.setXLocation(0);
					spawnDat.setYLocation(0);
					spawnDat.setZLocation(0);
			...
			while (rset1.next())
			{
				...
				while (rset2.next())
				{
					...
					if (template1 != null)
					{
						...
						spawnDat.setXLocation(rset2.getInt("locx"));
						spawnDat.setYLocation(rset2.getInt("locy"));
						spawnDat.setZLocation(rset2.getInt("locz"));
		...
		for (int i = 0; i <= 3; i++)
		{
			...
			if (template != null)
			{
				try
				{
					spawnDat = new L2Spawn(template);
					spawnDat.setAmount(1);
					spawnDat.setXLocation(_shadowSpawnLoc[locNo][i][1]);
					spawnDat.setYLocation(_shadowSpawnLoc[locNo][i][2]);
					spawnDat.setZLocation(_shadowSpawnLoc[locNo][i][3]);
				...
				if (spawnKeyBoxMob)
				{
					try
					{
						...
						if (template != null)
						{
							...
							keyBoxMobSpawn.setXLocation(spawnDat.getLocx());
							keyBoxMobSpawn.setYLocation(spawnDat.getLocy());
							keyBoxMobSpawn.setZLocation(spawnDat.getLocz());
	...
	public void spawnKeyBox(L2Npc activeChar)
	{
		...
		{
			spawnDat.setAmount(1);
			spawnDat.setXLocation(activeChar.getX());
			spawnDat.setYLocation(activeChar.getY());
			spawnDat.setZLocation(activeChar.getZ());
