...
{
	protected static final Logger _log = Logger.getLogger(ServerVariables.class.getName());
	...
	private static void LoadFromDB()
	{
		...
		{
			_log.info("ServerVariables: Could not load table");
		}
	}
	...
	private static void SaveToDB(String name)
	{
		...
		{
			_log.info("ServerVariables: Could not save table");
		}
	}
