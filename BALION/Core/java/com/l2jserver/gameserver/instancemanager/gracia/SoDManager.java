...
public final class SoDManager
{
	...
	protected SoDManager()
	{
		...
		loadData();
		handleSodStages();
		_log.info("Seed of Destruction: Current stage is: " + getSoDState());
	}
	...
	private void handleSodStages()
	{
		switch (_SoDState)
		{
			...
			case 3:
				...
				break;
			default:
				_log.info(getClass().getSimpleName() + ": Unknown Seed of Destruction state(" + _SoDState + ")! ");
		}
	}
	...
	public void updateSodState()
	{
		...
		if (quest == null)
		{
			_log.info(getClass().getSimpleName() + ": missing EnergySeeds Quest!");
		}
		else
		{
