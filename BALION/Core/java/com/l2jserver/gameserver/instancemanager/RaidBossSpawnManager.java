...
{
	protected static Logger _log = Logger.getLogger(RaidBossSpawnManager.class.getName());
		...
		try
		{
			...
			while (rset.next())
			{
				...
				if (template != null)
				{
					...
					spawnDat.setXLocation(rset.getInt("loc_x"));
					spawnDat.setYLocation(rset.getInt("loc_y"));
					spawnDat.setZLocation(rset.getInt("loc_z"));
