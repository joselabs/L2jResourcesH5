...
public class BelethCamera extends L2GameServerPacket
{
	 ...
	 */
	public BelethCamera(int id, int dist, int yaw, int pitch, int time, int duration)
	{
		_id = id;
		_dist = dist;
		_yaw = yaw;
	 ...
	 * @param unk
	 */
	public BelethCamera(int id, int dist, int yaw, int pitch, int time, int duration, int turn, int rise, int widescreen, int unk)
	{
		_id = id;
		_dist = dist;
		_yaw = yaw;
