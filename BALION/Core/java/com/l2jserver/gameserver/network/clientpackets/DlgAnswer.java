...
public final class DlgAnswer extends L2GameClientPacket
{
	...
	public static int _requesterId;
	...
	public void runImpl()
	{
		...
		if (MonsterRush._status == MonsterRush.Status.REGISTER)
		{
			if ((activeChar.getObjectId() == _requesterId) && (DlgAnswer._answer == 1))
			{
				MonsterRush.doReg(activeChar);
			}
			else if ((activeChar.getObjectId() == _requesterId) && (DlgAnswer._answer == 0))
			{
				activeChar.sendMessage("You leave registration from Monster Rush event.");
			}
		}
	}
