...
public class HtmCache
{
	...
	/*
	 * public String getHtm(L2PcInstance activeChar, String path) { String newPath = null; String content; String prefix = activeChar == null ? null : activeChar.getHtmlPrefix(); if ((prefix != null) && !prefix.isEmpty()) { newPath = prefix + path; content = getHtm(newPath); if (content != null) {
	 * if ((activeChar != null) && activeChar.isGM()) { activeChar.sendMessage("HtmlPath: " + getClass() + " -  " + newPath); } return content; } } content = getHtm(path); if ((content != null) && (newPath != null)) { _cache.put(newPath, content); } if ((activeChar != null) && activeChar.isGM()) {
	 * activeChar.sendCoreMessage("HtmlPath:$1", getClass(), path); } return content; }
	 */
	...
	public String getHtm(String prefix, String path)
	{
		...
		if ((prefix != null) && !prefix.isEmpty())
		{
			...
			if (content != null)
			{
				if (Config.ENABLE_HTML_PATH)
				{
					_log.info("HtmlPath: " + newPath);
				}
				return content;
			}
		}
