 ...
 * @author Adry_85
 */
public final class MithrilMine extends L2AttackableAIScript
{
	...
	public MithrilMine()
	{
		super(-1, MithrilMine.class.getSimpleName(), "freya");
		FirstTalkNpcs(KEGOR);
		KillNpcs(KEGOR, MITHRIL_MILLIPEDE);
		StartNpcs(TARUN, KRUN);
		TalkNpcs(TARUN, KRUN, KEGOR);
	}
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (event)
		{
			...
			case "FINISH":
			{
				...
				{
					if ((knownChar != null) && (knownChar.getNpcId() == KEGOR))
					{
						...
						broadcastNpcSay(kegor, Say2.ALL, "I can finally take a breather. By the way, who are you? Hmm... I think I know who sent you.");
					}
				}
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isSummon)
	{
		...
		if (_world != null)
		{
			...
			{
				broadcastNpcSay(npc, Say2.ALL, "How could I... fall... in a place like this...");
	...
	protected int enterInstance(L2PcInstance player, InstanceWorld instance, String template, int templateId)
	{
		...
		if (world != null)
		{
			...
			managePlayerEnter(player, (MMWorld) world);
		...
		else
		{
			...
			_log.info("Mithril Mines " + template + " Instance: " + instanceId + " created by player: " + player.getName());
			managePlayerEnter(player, (MMWorld) world);
	...
	private void managePlayerEnter(L2PcInstance player, MMWorld world)
	{
