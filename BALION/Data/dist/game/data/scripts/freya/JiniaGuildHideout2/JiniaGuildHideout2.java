 ...
 */
package freya.JiniaGuildHideout2;
 ...
 * @author Adry_85
 */
public final class JiniaGuildHideout2 extends L2AttackableAIScript
{
	...
	{
		super(-1, JiniaGuildHideout2.class.getSimpleName(), "freya");
		StartNpcs(RAFFORTY);
		TalkNpcs(RAFFORTY);
	}
	...
	protected int enterInstance(L2PcInstance player, InstanceWorld instance, String template, int templateId)
	{
		...
		if (world != null)
		{
			...
			managePlayerEnter(player, (JGH2World) world);
		...
		else
		{
			...
			_log.info("Jinia Hideout 2 " + template + " Instance: " + instanceId + " created by player: " + player.getName());
			managePlayerEnter(player, (JGH2World) world);
			return instanceId;
		}
	}
	
	private void managePlayerEnter(L2PcInstance player, JGH2World world)
	{
