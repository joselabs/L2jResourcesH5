 ...
 * @author Adry_85
 */
public final class KamaelChange2 extends L2AttackableAIScript
{
	// NPCs
	...
	{
		super(-1, KamaelChange2.class.getSimpleName(), "village_master");
		StartNpcs(NPCS_MALE);
		StartNpcs(NPCS_FEMALE);
		TalkNpcs(NPCS_MALE);
		TalkNpcs(NPCS_FEMALE);
	}
	...
	{
		String htmltext = null;
		if ((player.getClassId().getId() == 123) || (player.getClassId().getId() == 124))
		{
			if (Util.contains(NPCS_MALE, npc.getNpcId()))
			{
		...
		else if ((player.getClassId().getId() == 127) || (player.getClassId().getId() == 128) || (player.getClassId().getId() == 129) || (player.getClassId().getId() == 130) || (player.getClassId().getId() == 135))
		{
			if (Util.contains(NPCS_MALE, npc.getNpcId()))
			{
		...
		else if ((player.getClassId().getId() == 131) || (player.getClassId().getId() == 132) || (player.getClassId().getId() == 133) || (player.getClassId().getId() == 134) || (player.getClassId().getId() == 136))
		{
			if (Util.contains(NPCS_MALE, npc.getNpcId()))
			{
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		else if ((player.getClassId().getId() == 123) || (player.getClassId().getId() == 124))
		{
		...
		else if ((player.getClassId().getId() == 125) || (player.getClassId().getId() == 126))
		{
			if (Util.contains(NPCS_MALE, npc.getNpcId()))
			{
				if ((player.getClassId().getId() == 124) || (player.getClassId().getId() == 126) || (player.getClassId().getId() == 129) || (player.getClassId().getId() == 130) || (player.getClassId().getId() == 133) || (player.getClassId().getId() == 134) || (player.getClassId().getId() == 128) || (player.getClassId().getId() == 132) || (player.getClassId().getId() == 135) || (player.getClassId().getId() == 136))
				{
					htmltext = "32145-04.htm"; // master_all_kamael002b
					return htmltext;
				}
			...
			{
				if ((player.getClassId().getId() == 123) || (player.getClassId().getId() == 125) || (player.getClassId().getId() == 127) || (player.getClassId().getId() == 128) || (player.getClassId().getId() == 131) || (player.getClassId().getId() == 132) || (player.getClassId().getId() == 129) || (player.getClassId().getId() == 133) || (player.getClassId().getId() == 135) || (player.getClassId().getId() == 136))
				{
					htmltext = "32145-10.htm"; // master_all_kamael002c
					return htmltext;
				}
