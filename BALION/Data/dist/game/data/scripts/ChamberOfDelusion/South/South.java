package ChamberOfDelusion.South;
...
public class South extends Quest
{
	...
	{
		{32674,-122368,-207920,-6720,0},
		{32675,-122368,-207040,-6720,0},
		{32676,-122368,-209216,-6720,0},
		{32677,-121456,-207456,-6720,0},
		{32678,-121440,-209104,-6720,0}
		
	};
	
	private final int[][] BOX_SPAWN_POINTS =
	{
		{-121292,-208690,-6720,0},
		{-121605,-208850,-6720,0},
		{-121622,-209341,-6720,0},
	...
	private void enter(CDWorld world)
	{
		...
		for (L2PcInstance partyMember : party.getPartyMembers())
		{
			QuestState st = partyMember.getQuestState(South.class.getSimpleName());
			if (st == null)
			{
	...
	private void exitInstance(L2PcInstance player)
	{
		...
		QuestState st = player.getQuestState(South.class.getSimpleName());
	...
	public South()
	{
		super(-1, South.class.getSimpleName(), "ChamberOfDelusion");
