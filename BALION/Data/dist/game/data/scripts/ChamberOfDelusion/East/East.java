package ChamberOfDelusion.East;
...
public class East extends Quest
{
	...
	private void enter(CDWorld world)
	{
		...
		for (L2PcInstance partyMember : party.getPartyMembers())
		{
			QuestState st = partyMember.getQuestState(East.class.getSimpleName());
			if (st == null)
			{
	...
	private void exitInstance(L2PcInstance player)
	{
		...
		QuestState st = player.getQuestState(East.class.getSimpleName());
	...
	public East()
	{
		super(-1, East.class.getSimpleName(), "ChamberOfDelusion");
