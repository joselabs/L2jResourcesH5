package ChamberOfDelusion.North;
...
public class North extends Quest
{
	...
	private void enter(CDWorld world)
	{
		...
		for (L2PcInstance partyMember : party.getPartyMembers())
		{
			QuestState st = partyMember.getQuestState(North.class.getSimpleName());
			if (st == null)
			{
	...
	private void exitInstance(L2PcInstance player)
	{
		...
		QuestState st = player.getQuestState(North.class.getSimpleName());
	...
	public North()
	{
		super(-1, North.class.getSimpleName(), "ChamberOfDelusion");
