package ChamberOfDelusion.West;
...
public class West extends Quest
{
	...
	private void enter(CDWorld world)
	{
		...
		for (L2PcInstance partyMember : party.getPartyMembers())
		{
			QuestState st = partyMember.getQuestState(West.class.getSimpleName());
			if (st == null)
			{
	...
	private void exitInstance(L2PcInstance player)
	{
		...
		QuestState st = player.getQuestState(West.class.getSimpleName());
	...
	public West()
	{
		super(-1, West.class.getSimpleName(), "ChamberOfDelusion");
