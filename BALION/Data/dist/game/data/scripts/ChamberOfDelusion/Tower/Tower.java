package ChamberOfDelusion.Tower;
...
public class Tower extends Quest
{
	...
	private void enter(CDWorld world)
	{
		...
		for (L2PcInstance partyMember : party.getPartyMembers())
		{
			QuestState st = partyMember.getQuestState(Tower.class.getSimpleName());
			if (st == null)
			{
	...
	private void exitInstance(L2PcInstance player)
	{
		...
		QuestState st = player.getQuestState(Tower.class.getSimpleName());
	...
	public Tower()
	{
		super(-1, Tower.class.getSimpleName(), "ChamberOfDelusion");
