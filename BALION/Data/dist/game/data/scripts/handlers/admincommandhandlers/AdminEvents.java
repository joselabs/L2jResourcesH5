...
public class AdminEvents implements IAdminCommandHandler
{
	...
	private void showMenu(L2PcInstance activeChar)
	{
		...
		for (Quest event : QuestManager.getInstance().getAllManagedScripts())
		{
			...
			{
				StringUtil.append(cList, "<font name=hs12 color=\"LEVEL\">" + event.getName() + ":</font>", "<table width=270><tr>", "<td><button value=\"Start\" action=\"bypass -h admin_event_start_menu " + event.getName() + "\" width=80 height=21 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>", "<td><button value=\"Stop\" action=\"bypass -h admin_event_stop_menu " + event.getName() + "\" width=80 height=21 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>", "<td><button value=\"Menu\" action=\"bypass -h admin_event_bypass " + event.getName() + "\" width=80 height=21 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>", "</tr></table><br>");
			}
		}
