...
public class AdminFightCalculator implements IAdminCommandHandler
{
	...
	private void handleStart(String params, L2PcInstance activeChar)
	{
		...
		{
			replyMSG = StringUtil.concat("<html><title>Selected mobs to fight</title>" + "<body>" + "<table>" + "<tr><td>First</td><td>Second</td></tr>" + "<tr><td>level ", String.valueOf(lvl1), "</td><td>level ", String.valueOf(lvl2), "</td></tr>" + "<tr><td>id ", String.valueOf(npc1.npcId), "</td><td>id ", String.valueOf(npc2.npcId), "</td></tr>" + "<tr><td>", npc1.getName(), "</td><td>", npc2.getName(), "</td></tr>" + "</table>" + "<center><br><br><br>" + "<button value=\"OK\" action=\"bypass -h admin_fight_calculator_show ", String.valueOf(npc1.npcId), " ", String.valueOf(npc2.npcId), "\"  width=100 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">" + "</center>" + "</body></html>");
		}
		else if ((lvl1 != 0) && (npc1 == null))
		{
			...
			{
				StringUtil.append(sb, "<tr><td><a action=\"bypass -h admin_fight_calculator lvl1 ", String.valueOf(lvl1), " lvl2 ", String.valueOf(lvl2), " mid1 ", String.valueOf(n.npcId), " mid2 ", String.valueOf(mid2), "\">", n.getName(), "</a></td></tr>");
			}
		...
		else if ((lvl2 != 0) && (npc2 == null))
		{
			...
			for (L2NpcTemplate n : npcs)
			{
				StringUtil.append(sb, "<tr><td><a action=\"bypass -h admin_fight_calculator lvl1 ", String.valueOf(lvl1), " lvl2 ", String.valueOf(lvl2), " mid1 ", String.valueOf(mid1), " mid2 ", String.valueOf(n.npcId), "\">", n.getName(), "</a></td></tr>");
			}
