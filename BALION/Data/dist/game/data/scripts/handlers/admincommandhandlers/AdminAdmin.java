...
public class AdminAdmin implements IAdminCommandHandler
{
	...
	private static final String[] ADMIN_COMMANDS =
	{
		...
		"admin_setday",
		"admin_setnight",
		"belethstart", // this command start Beleth Boss and teleport you to room before Beleth Chamber
		"belethreset", // Reset GB status
	};
	
	@Override
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		if (command.startsWith("admin_setday"))
		{
			GameTimeController.getInstance().isDay();
			DayNightSpawnManager.getInstance().spawnDayCreatures();
		}
		else if (command.startsWith("belethstart"))
		{
			GrandBossManager.getInstance().setBossStatus(29118, 1);
			activeChar.teleToLocation(16342, 209557, -9352, true);
		}
		else if (command.startsWith("belethreset"))
		{
			GrandBossManager.getInstance().setBossStatus(29118, 0);
		}
		else if (command.startsWith("admin_setnight"))
		{
			GameTimeController.getInstance().isNight();
			DayNightSpawnManager.getInstance().spawnNightCreatures();
			
		}
		else if (command.startsWith("admin_admin"))
		{
			showMainPage(activeChar, command);
			activeChar.sendMessage("X:" + activeChar.getX() + " Y" + activeChar.getY() + " Z" + activeChar.getZ() + " Heading" + activeChar.getHeading() + "");
		}
		...
		else if (command.startsWith("admin_reload"))
		{
			...
			try
			{
				...
				else if (type.equals("fakepcs"))
				{
					FakePcsTable.getInstance().reloadData();
					activeChar.sendMessage("All Fake PCs have been reloaded");
				}
				...
				else if (type.startsWith("npcwalkers"))
				{
					...
					activeChar.sendMessage("NPC Walker Manager have been reloaded");
				}
	...
	public void showConfigPage(L2PcInstance activeChar)
	{
		...
		replyMSG.append("<tr><td><font color=\"LEVEL\">Enchant Weapon</font> = " + Config.ENCHANT_CHANCE_WEAPON + "</td><td><edit var=\"param5\" width=40 height=15></td><td><button value=\"Set\" action=\"bypass -h admin_setconfig EnchantChanceWeapon $param5\" width=40 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr>");
		replyMSG.append("<tr><td><font color=\"LEVEL\">Enchant Armor</font> = " + Config.ENCHANT_CHANCE_ARMOR + "</td><td><edit var=\"param6\" width=40 height=15></td><td><button value=\"Set\" action=\"bypass -h admin_setconfig EnchantChanceArmor $param6\" width=40 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr>");
		replyMSG.append("<tr><td><font color=\"LEVEL\">Enchant Jewelry</font> = " + Config.ENCHANT_CHANCE_JEWELRY + "</td><td><edit var=\"param7\" width=40 height=15></td><td><button value=\"Set\" action=\"bypass -h admin_setconfig EnchantChanceJewelry $param7\" width=40 height=25 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr>");
