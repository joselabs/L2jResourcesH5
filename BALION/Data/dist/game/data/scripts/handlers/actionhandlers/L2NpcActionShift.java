...
public class L2NpcActionShift implements IActionHandler
{
	...
	public boolean action(L2PcInstance activeChar, L2Object target, boolean interact)
	{
		...
		if (activeChar.getAccessLevel().isGm())
		{
			...
			if (((L2Npc) target).hasAI() || target.isMonster())
			{
				html.replace("%spawn_name%", "<tr><td><table width=270 border=0><tr><td width=100><font color=FFAA00>Spawn Name:</font></td><td align=right width=170>" + ((L2Npc) target).getSpawn().getName() + "</td></tr></table></td></tr>");
				...
				html.replace("%ai_script_value%", "<tr><td><table width=270 border=0><tr><td width=100><font color=FFAA00>Script Value:</font></td><td align=right width=170>" + ((L2Npc) target).getScriptValue() + "</td></tr></table></td></tr>");
				html.replace("%ai_visible%", "<tr><td><table width=270 border=0><tr><td width=100><font color=FFAA00>Visible?</font></td><td align=right width=170>" + ((L2Npc) target).isVisible() + "</td></tr></table></td></tr>");
			}
			else
			{
