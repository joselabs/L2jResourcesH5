...
import handlers.admincommandhandlers.AdminGB;
...
import handlers.admincommandhandlers.AdminMonsterRush;
...
import handlers.voicedcommandhandlers.CastleManagerInfo;
...
import handlers.voicedcommandhandlers.MonsterRushRegistration;
import handlers.voicedcommandhandlers.OpenAtod;
import handlers.voicedcommandhandlers.PremiumInfo;
import handlers.voicedcommandhandlers.Teleports;
import handlers.voicedcommandhandlers.TvTRoundVoicedInfo;
import handlers.voicedcommandhandlers.TvTRoundVoicedRegistration;
import handlers.voicedcommandhandlers.TvTVoicedInfo;
import handlers.voicedcommandhandlers.TvTVoicedRegistration;
 ...
 */
public class StartLoadingAllHandlers implements Runnable
{
	protected static final Logger _log = Logger.getLogger(StartLoadingAllHandlers.class.getName());
	
	@Override
	public void run()
	{
		loadAllhandlers();
		_log.info("Manager for handlers is loaded.");
	}
	...
	private static void loadAllhandlers()
	{
		...
		_log.config("Loaded " + ActionHandler.getInstance().size() + "  Action Handlers");
		...
		_log.config("Loaded " + ActionHandler.getInstance().sizeShift() + " Action Shift Handlers");
		...
		AdminCommandHandler.getInstance().registerAdminCommandHandler(new AdminGB());
		...
		_log.config("Loaded " + AdminCommandHandler.getInstance().size() + "  Admin Command Handlers");
		...
		_log.config("Loaded " + BypassHandler.getInstance().size() + "  Bypass Handlers");
		...
		_log.config("Loaded " + ChatHandler.getInstance().size() + "  Chat Handlers");
		...
		_log.config("Loaded " + ItemHandler.getInstance().size() + " Item Handlers");
		...
		_log.config("Loaded " + SkillHandler.getInstance().size() + " Skill Handlers");
		...
		_log.config("Loaded " + UserCommandHandler.getInstance().size() + " User Handlers");
		...
		VoicedCommandHandler.getInstance().registerVoicedCommandHandler(new Teleports());
		VoicedCommandHandler.getInstance().registerVoicedCommandHandler(new PremiumInfo());
		VoicedCommandHandler.getInstance().registerVoicedCommandHandler(new ChangePassword());
		VoicedCommandHandler.getInstance().registerVoicedCommandHandler(new CastleManagerInfo());
		...
		VoicedCommandHandler.getInstance().registerVoicedCommandHandler(new OpenAtod());
		VoicedCommandHandler.getInstance().registerVoicedCommandHandler(new TvTVoicedRegistration());
		VoicedCommandHandler.getInstance().registerVoicedCommandHandler(new TvTRoundVoicedRegistration());
		VoicedCommandHandler.getInstance().registerVoicedCommandHandler(new MonsterRushRegistration());
		VoicedCommandHandler.getInstance().registerVoicedCommandHandler(new DressMe());
		
		_log.config("Loaded " + VoicedCommandHandler.getInstance().size() + " Voiced Handlers");
		// End of loading list
		_log.config("Loading handlers  is completed.");
	}
