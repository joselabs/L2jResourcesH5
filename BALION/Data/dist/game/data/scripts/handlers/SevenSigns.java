...
import seven_signs.HideoutOfTheDawn.HideoutOfTheDawn;
import seven_signs.SanctumOftheLordsOfDawn.SanctumOftheLordsOfDawn;
...
{
	private static final Logger _log = Logger.getLogger(SevenSigns.class.getName());
	
	private static final Class<?>[] SSQ =
	{
