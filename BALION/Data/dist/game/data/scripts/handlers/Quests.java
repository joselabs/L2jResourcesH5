...
import quests.Q00196_SevenSignSealOfTheEmperor.Q00196_SevenSignSealOfTheEmperor;
...
import quests.Q147_PathtoBecominganEliteMercenary.Q147_PathtoBecominganEliteMercenary;
import quests.Q148_PathtoBecominganExaltedMercenary.Q148_PathtoBecominganExaltedMercenary;
import quests.Q153_DeliverGoods.Q153_DeliverGoods;
import quests.Q179_IntoTheLargeCavern.Q179_IntoTheLargeCavern;
import quests.Q182_NewRecruits.Q182_NewRecruits;
import quests.Q307_ControlDeviceOfTheGiants.Q307_ControlDeviceOfTheGiants;
import quests.Q350_EnhanceYourWeapon.Q350_EnhanceYourWeapon;
import quests.Q511_AwlUnderFoot.Q511_AwlUnderFoot;
import quests.Q636_TruthBeyond.Q636_TruthBeyond;
import quests.Q637_ThroughOnceMore.Q637_ThroughOnceMore;
...
public class Quests
{
	private static final Logger _log = Logger.getLogger(Quests.class.getName());
	...
	private static final Class<?>[] QUESTS =
	{
		...
		Q147_PathtoBecominganEliteMercenary.class,
		Q148_PathtoBecominganExaltedMercenary.class,
		Q153_DeliverGoods.class,
		Q179_IntoTheLargeCavern.class,
		Q182_NewRecruits.class,
		Q307_ControlDeviceOfTheGiants.class,
		Q350_EnhanceYourWeapon.class,
		Q511_AwlUnderFoot.class,
		Q636_TruthBeyond.class,
		Q637_ThroughOnceMore.class,
		Q692_HowtoOpposeEvil.class,
	};
	boolean ENABLED_LOADING_INFO = false;
	
	public Quests()
	{
		for (Class<?> file : QUESTS)
		{
			try
			{
				file.newInstance();
				...
				{
					_log.info("Quests Loader: loading " + file.getSimpleName());
				}
			}
			catch (Exception e)
			{
