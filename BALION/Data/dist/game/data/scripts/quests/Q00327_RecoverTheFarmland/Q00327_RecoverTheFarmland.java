...
public final class Q00327_RecoverTheFarmland extends Quest
{
	...
	public Q00327_RecoverTheFarmland()
	{
		...
		StartNpcs(LEIKAN, PIOTUR);
		TalkNpcs(LEIKAN, PIOTUR, IRIS, ASHA, NESTLE);
		KillNpcs(TUREK_ORK_WARLORD, TUREK_ORK_ARCHER, TUREK_ORK_SKIRMISHER, TUREK_ORK_SUPPLIER, TUREK_ORK_FOOTMAN, TUREK_ORK_SENTINEL, TUREK_ORK_SHAMAN);
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		if (st != null)
		{
			if ((npc.getNpcId() == TUREK_ORK_SHAMAN) || (npc.getNpcId() == TUREK_ORK_WARLORD))
			{
			...
			if (getRandom(100) < FRAGMENTS_DROP_PROB.get(npc.getNpcId()))
			{
