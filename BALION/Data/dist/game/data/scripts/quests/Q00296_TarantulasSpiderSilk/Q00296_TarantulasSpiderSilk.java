...
public final class Q00296_TarantulasSpiderSilk extends Quest
{
	...
	public Q00296_TarantulasSpiderSilk()
	{
		...
		StartNpcs(TRADER_MION);
		TalkNpcs(TRADER_MION, DEFENDER_NATHAN);
		KillNpcs(MONSTERS);
	...
	public String onTalk(L2Npc npc, L2PcInstance talker)
	{
		...
		if (qs.isCreated() && (npc.getNpcId() == TRADER_MION))
		{
			html = (talker.getLevel() >= MIN_LVL ? "30519-02.htm" : "30519-01.htm");
		}
		else if (qs.isStarted())
		{
			if (npc.getNpcId() == TRADER_MION)
			{
			...
			else if (npc.getNpcId() == DEFENDER_NATHAN)
			{
				html = "30548-01.html";
			}
		}
