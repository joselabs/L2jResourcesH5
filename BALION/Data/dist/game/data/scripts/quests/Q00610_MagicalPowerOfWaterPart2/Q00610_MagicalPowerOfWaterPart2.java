...
public class Q00610_MagicalPowerOfWaterPart2 extends Quest
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		else
		{
			...
			{
				npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "The power of constraint is getting weaker. Your ritual has failed!"));
				npc.deleteMe();
				addSpawn(VARKA_TOTEM, 105452, -36775, -1050, 34000, false, 0, true);
			}
	...
	private String spawnAshutar(L2Npc npc, QuestState st)
	{
		...
		ashutar.broadcastPacket(new CreatureSay(ashutar.getObjectId(), 1, ashutar.getName(), "The magical power of water comes from the power of storm and hail! If you dare to confront it, only death will await you!"));
