...
public final class Q00625_TheFinestIngredientsPart2 extends Quest
{
	...
	public Q00625_TheFinestIngredientsPart2()
	{
		...
		StartNpcs(JEREMY);
		TalkNpcs(JEREMY, YETIS_TABLE);
		SpawnNpcs(ICICLE_EMPEROR_BUMBALUMP);
		KillNpcs(ICICLE_EMPEROR_BUMBALUMP);
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (event)
		{
			...
			case "NPC_TALK":
			{
				if (isBumbalumpSpawned())
				{
					npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "OooH!"));
				}
				break;
			}
		}
	...
	public String onSpawn(L2Npc npc)
	{
		...
		npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "I smell something delicious"));
