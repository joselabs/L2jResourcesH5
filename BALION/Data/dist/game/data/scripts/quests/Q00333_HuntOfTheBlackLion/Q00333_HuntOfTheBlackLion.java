...
public final class Q00333_HuntOfTheBlackLion extends Quest
{
	...
	public Q00333_HuntOfTheBlackLion()
	{
		...
		StartNpcs(MERCENARY_CAPTAIN_SOPHYA);
		TalkNpcs(MERCENARY_CAPTAIN_SOPHYA, ABYSSAL_CELEBRANT_UNDRIAS, BLACKSMITH_RUPIO, IRON_GATES_LOCKIRIN, MERCENARY_REEDFOOT, GUILDSMAN_MORGON);
		KillNpcs(MARSH_STAKATO, NEER_CRAWLER, SPECTER, SORROW_MAIDEN, NEER_CRAWLER_BERSERKER, STRAIN, GHOUL, OL_MAHUM_GUERILLA, OL_MAHUM_RAIDER, OL_MAHUM_MARKSMAN, OL_MAHUM_SERGEANT, OL_MAHUM_CAPTAIN, MARSH_STAKATO_WORKER, MARSH_STAKATO_SOLDIER, MARSH_STAKATO_DRONE, DELU_LIZARDMAN, DELU_LIZARDMAN_SCOUT, DELU_LIZARDMAN_WARRIOR, DELU_LIZARDMAN_HEADHUNTER, MARSH_STAKATO_MARQUESS);
		...
		switch (event)
		{
			...
			case "30735-16.html":
			{
				...
				else if ((getQuestItemsCount(player, LIONS_CLAW) >= 10) && (getQuestItemsCount(player, LIONS_EYE) < 4))
				{
					...
					{
						if ((player.getClassId().getId() == 0) || // <!-- Human Fighter -->
							(player.getClassId().getId() == 1) || // <!-- Warrior -->
							(player.getClassId().getId() == 2) || // <!-- Gladiator -->
							(player.getClassId().getId() == 3) || // <!-- Warlord -->
							(player.getClassId().getId() == 4) || // <!-- Human Knight -->
							(player.getClassId().getId() == 5) || // <!-- Paladin -->
							(player.getClassId().getId() == 6) || // <!-- Dark Avenger -->
							(player.getClassId().getId() == 7) || // <!-- Rogue -->
							(player.getClassId().getId() == 8) || // <!-- Treasure Hunter -->
							(player.getClassId().getId() == 9) || // <!-- Hawkeye -->
							(player.getClassId().getId() == 18) || // <!-- Elven Fighter -->
							(player.getClassId().getId() == 19) || // <!-- Elven Knight -->
							(player.getClassId().getId() == 20) || // <!-- Temple Knight -->
							(player.getClassId().getId() == 21) || // <!-- Sword Singer -->
							(player.getClassId().getId() == 22) || // <!-- Elven Scout -->
							(player.getClassId().getId() == 23) || // <!-- Plains Walker -->
							(player.getClassId().getId() == 24) || // <!-- Silver Ranger -->
							(player.getClassId().getId() == 31) || // <!-- Dark Fighter -->
							(player.getClassId().getId() == 32) || // <!-- Palus Knight -->
							(player.getClassId().getId() == 33) || // <!-- Shillien Knight -->
							(player.getClassId().getId() == 34) || // <!-- Bladedancer -->
							(player.getClassId().getId() == 35) || // <!-- Assassin -->
							(player.getClassId().getId() == 36) || // <!-- Abyss Walker -->
							(player.getClassId().getId() == 37) || // <!-- Phantom Ranger -->
							(player.getClassId().getId() == 44) || // <!-- Orc Fighter -->
							(player.getClassId().getId() == 45) || // <!-- Orc Raider -->
							(player.getClassId().getId() == 46) || // <!-- Destroyer -->
							(player.getClassId().getId() == 47) || // <!-- Monk -->
							(player.getClassId().getId() == 48) || // <!-- Tyrant -->
							(player.getClassId().getId() == 53) || // <!-- Dwarf Fighter -->
							(player.getClassId().getId() == 54) || // <!-- Scavenger -->
							(player.getClassId().getId() == 55) || // <!-- Bounty Hunter -->
							(player.getClassId().getId() == 56) || // <!-- Artisan -->
							(player.getClassId().getId() == 57) || // <!-- Warsmith -->
							(player.getClassId().getId() == 88) || // <!-- Duelist -->
							(player.getClassId().getId() == 89) || // <!-- Dreadnought -->
							(player.getClassId().getId() == 90) || // <!-- Phoenix Knight -->
							(player.getClassId().getId() == 91) || // <!-- Hell Knight -->
							(player.getClassId().getId() == 92) || // <!-- Sagittarius -->
							(player.getClassId().getId() == 93) || // <!-- Adventurer -->
							(player.getClassId().getId() == 99) || // <!-- Eva's Templar -->
							(player.getClassId().getId() == 100) || // <!-- Sword Muse -->
							(player.getClassId().getId() == 101) || // <!-- Wind Rider -->
							(player.getClassId().getId() == 102) || // <!-- Moonlight Sentinel -->
							(player.getClassId().getId() == 106) || // <!-- Shillien Templar -->
							(player.getClassId().getId() == 107) || // <!-- Spectral Dancer -->
							(player.getClassId().getId() == 108) || // <!-- Ghost Hunter -->
							(player.getClassId().getId() == 109) || // <!-- Ghost Sentinel -->
							(player.getClassId().getId() == 113) || // <!-- Titan -->
							(player.getClassId().getId() == 114) || // <!-- Grand Khavatari -->
							(player.getClassId().getId() == 117) || // <!-- Fortune Seeker -->
							(player.getClassId().getId() == 118) || // <!-- Maestro -->
							(player.getClassId().getId() == 123) || // <!-- Male Kamael Soldier -->
							(player.getClassId().getId() == 124) || // <!-- Female Kamael Soldier -->
							(player.getClassId().getId() == 125) || // <!-- Trooper -->
							(player.getClassId().getId() == 126) || // <!-- Warder -->
							(player.getClassId().getId() == 127) || // <!-- Berserker -->
							(player.getClassId().getId() == 128) || // <!-- Male Soul Breaker -->
							(player.getClassId().getId() == 129) || // <!-- Female Soul Breaker -->
							(player.getClassId().getId() == 130) || // <!-- Arbalester -->
							(player.getClassId().getId() == 131) || // <!-- Doombringer -->
							(player.getClassId().getId() == 132) || // <!-- Male Soul Hound -->
							(player.getClassId().getId() == 133) || // <!-- Female Soul Hound -->
							(player.getClassId().getId() == 134) || // <!-- Trickster -->
							(player.getClassId().getId() == 135) || // <!-- Inspector -->
							(player.getClassId().getId() == 136)) // <!-- Judicator -->
						{
							giveItems(player, SOULSHOT_D_GRADE, 100);
						}
						else if ((player.getClassId().getId() == 10) || // <!-- Human Mystic -->
							(player.getClassId().getId() == 11) || // <!-- Human Wizard -->
							(player.getClassId().getId() == 12) || // <!-- Sorcerer -->
							(player.getClassId().getId() == 13) || // <!-- Necromancer -->
							(player.getClassId().getId() == 14) || // <!-- Warlock -->
							(player.getClassId().getId() == 15) || // <!-- Cleric -->
							(player.getClassId().getId() == 16) || // <!-- Bishop -->
							(player.getClassId().getId() == 17) || // <!-- Prophet -->
							(player.getClassId().getId() == 25) || // <!-- Elven Mystic -->
							(player.getClassId().getId() == 26) || // <!-- Elven Wizard -->
							(player.getClassId().getId() == 27) || // <!-- Spellsinger -->
							(player.getClassId().getId() == 28) || // <!-- Elemental Summoner -->
							(player.getClassId().getId() == 29) || // <!-- Elven Oracle -->
							(player.getClassId().getId() == 30) || // <!-- Elven Elder -->
							(player.getClassId().getId() == 38) || // <!-- Dark Mystic -->
							(player.getClassId().getId() == 39) || // <!-- Dark Wizard -->
							(player.getClassId().getId() == 40) || // <!-- Spellhowler -->
							(player.getClassId().getId() == 41) || // <!-- Phantom Summoner -->
							(player.getClassId().getId() == 42) || // <!-- Shillien Oracle -->
							(player.getClassId().getId() == 43) || // <!-- Shillien Elder -->
							(player.getClassId().getId() == 49) || // <!-- Orc Mystic -->
							(player.getClassId().getId() == 50) || // <!-- Orc Shaman -->
							(player.getClassId().getId() == 51) || // <!-- Overlord -->
							(player.getClassId().getId() == 52) || // <!-- Warcryer -->
							(player.getClassId().getId() == 94) || // <!-- Archmage -->
							(player.getClassId().getId() == 95) || // <!-- Soultaker -->
							(player.getClassId().getId() == 96) || // <!-- Arcana Lord -->
							(player.getClassId().getId() == 97) || // <!-- Cardinal -->
							(player.getClassId().getId() == 98) || // <!-- Hierophant -->
							(player.getClassId().getId() == 103) || // <!-- Mystic Muse -->
							(player.getClassId().getId() == 104) || // <!-- Elemental Master -->
							(player.getClassId().getId() == 105) || // <!-- Eva's Saint -->
							(player.getClassId().getId() == 110) || // <!-- Storm Screamer -->
							(player.getClassId().getId() == 111) || // <!-- Spectral Master -->
							(player.getClassId().getId() == 112) || // <!-- Shillien Saint -->
			...
			switch (npc.getNpcId())
			{
				case MARSH_STAKATO:
				{
					if (hasQuestItems(killer, SOPHYAS_4TH_ORDER))
					{
						...
						{
							addSpawn(MARSH_STAKATO_MARQUESS, npc.getLocationXYZ(), true, 0, false);
						}
					}
					break;
				}
				...
				case DELU_LIZARDMAN_SCOUT:
				{
					...
					{
						addSpawn(DELU_LIZARDMAN_HEADHUNTER, npc.getLocationXYZ(), true, 0, false);
						addSpawn(DELU_LIZARDMAN_HEADHUNTER, npc.getLocationXYZ(), true, 0, false);
					}
					break;
				}
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (qs.isCreated())
		{
			if (npc.getNpcId() == MERCENARY_CAPTAIN_SOPHYA)
			{
