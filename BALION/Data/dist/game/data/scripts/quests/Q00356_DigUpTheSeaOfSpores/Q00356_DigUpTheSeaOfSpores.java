...
public final class Q00356_DigUpTheSeaOfSpores extends Quest
{
	...
	public Q00356_DigUpTheSeaOfSpores()
	{
		...
		StartNpcs(GAUEN);
		TalkNpcs(GAUEN);
		KillNpcs(ROTTING_TREE, SPORE_ZOMBIE);
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		final int dropItem = ((npc.getNpcId() == ROTTING_TREE) ? HERBIVOROUS_SPORE : CARNIVORE_SPORE);
		final int otherItem = ((dropItem == HERBIVOROUS_SPORE) ? CARNIVORE_SPORE : HERBIVOROUS_SPORE);
		
		if (giveItemRandomly(qs.getPlayer(), npc, dropItem, 1, 50, MONSTER_DROP_CHANCES.get(npc.getNpcId()), true))
		{
