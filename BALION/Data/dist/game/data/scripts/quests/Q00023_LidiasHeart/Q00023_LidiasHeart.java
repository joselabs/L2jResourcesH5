...
public final class Q00023_LidiasHeart extends Quest
{
	...
	public Q00023_LidiasHeart()
	{
		...
		StartNpcs(HIGH_PRIEST_INNOCENTIN);
		TalkNpcs(HIGH_PRIEST_INNOCENTIN, TRADER_VIOLET, TOMBSTONE, GHOST_OF_VON_HELLMANN, BROKEN_BOOKSHELF, BOX);
		SpawnNpcs(GHOST_OF_VON_HELLMANN);
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (qs.isCreated())
		{
			if (npc.getNpcId() == HIGH_PRIEST_INNOCENTIN)
			{
		...
		else if (qs.isCompleted())
		{
			...
			else if (npc.getNpcId() == TRADER_VIOLET)
			{
	...
	public String onSpawn(L2Npc npc)
	{
		...
		npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "Who awoke me???"));
