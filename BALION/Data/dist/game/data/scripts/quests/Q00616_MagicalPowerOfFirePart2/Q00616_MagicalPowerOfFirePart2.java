...
public class Q00616_MagicalPowerOfFirePart2 extends Quest
{
	...
	private String spawnNastron(L2Npc npc, QuestState st)
	{
		...
		nastron.broadcastPacket(new CreatureSay(nastron.getObjectId(), 1, nastron.getName(), "The magical power of fire is also the power of flames and lava! If you dare to confront it, only death will await you!"));
