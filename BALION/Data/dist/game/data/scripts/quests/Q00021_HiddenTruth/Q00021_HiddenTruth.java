...
public class Q00021_HiddenTruth extends Quest
{
	...
	public Q00021_HiddenTruth()
	{
		...
		StartNpcs(MYSTERIOUS_WIZARD);
		TalkNpcs(MYSTERIOUS_WIZARD, TOMBSTONE, GHOST_OF_VON_HELLMAN, GHOST_OF_VON_HELLMANS_PAGE, BROKEN_BOOKSHELF, AGRIPEL, BENEDICT, DOMINIC, INNOCENTIN);
		SeeCreatureNpcs(GHOST_OF_VON_HELLMANS_PAGE);
		RouteFinishedNpcs(GHOST_OF_VON_HELLMANS_PAGE);
			...
			switch (event)
			{
				...
				case "31523-03.html":
				{
					...
					else
					{
						...
						ghost.broadcastPacket(new CreatureSay(ghost.getObjectId(), 1, ghost.getName(), "Who awoke me???"));
						GHOST_SPAWNED = true;
				...
				case "31524-06.html":
				{
					if (PAGE_COUNT < 5)
					{
						...
						page.broadcastPacket(new CreatureSay(page.getObjectId(), 1, page.getName(), "My master has instructed me to be your guide, " + player.getName() + "."));
