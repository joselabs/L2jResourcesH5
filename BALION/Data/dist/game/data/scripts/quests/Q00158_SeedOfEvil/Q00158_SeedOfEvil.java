...
public class Q00158_SeedOfEvil extends Quest
{
	...
	public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isSummon)
	{
		...
		{
			npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "... How dare you challenge me!"));
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "The power of Lord Beleth rules the whole world...!"));
