...
public final class Q00501_ProofOfClanAlliance extends Quest
{
	...
	public Q00501_ProofOfClanAlliance()
	{
		...
		StartNpcs(SIR_KRISTOF_RODEMAI, STATUE_OF_OFFERING);
		TalkNpcs(SIR_KRISTOF_RODEMAI, STATUE_OF_OFFERING, ATHREA, KALIS);
		KillNpcs(OEL_MAHUM_WITCH_DOCTOR, HARIT_LIZARDMAN_SHAMAN, VANOR_SILENOS_SHAMAN, BOX_OF_ATHREA_1, BOX_OF_ATHREA_2, BOX_OF_ATHREA_3, BOX_OF_ATHREA_4, BOX_OF_ATHREA_5);
				...
				case BOX_OF_ATHREA_5:
				{
					...
					if ((summoner != null) && summoner.isNpc() && lqs.isMemoState(4))
					{
						...
						if ((lqs.getInt("flag") == 3) && arthea.isScriptValue(15))
						{
							...
							npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "##########Bingo!##########"));
						}
	...
	{
		return player.getEffectList().isAffected(POISON_OF_DEATH.getSkillId());
	}
