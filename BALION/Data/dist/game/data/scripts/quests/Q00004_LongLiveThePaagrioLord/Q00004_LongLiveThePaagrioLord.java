...
public class Q00004_LongLiveThePaagrioLord extends Quest
{
	...
	public Q00004_LongLiveThePaagrioLord()
	{
		...
		StartNpcs(NAKUSIN);
		TalkNpcs(NAKUSIN, VARKEES, URUTU, HESTUI, KUNAI, USKA, GROOKIN);
				...
				switch (st.getState())
				{
					...
					case State.STARTED:
						...
						else
						{
							st.giveItems(CLUB, 1);
							// Newbie Guide
							player.sendPacket(new ExShowScreenMessage("Delivery duty complete and go to find the Newbie Guide", 5000));
