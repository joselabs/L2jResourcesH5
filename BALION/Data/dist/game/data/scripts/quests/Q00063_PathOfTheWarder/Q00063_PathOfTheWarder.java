...
public final class Q00063_PathOfTheWarder extends Quest
{
	...
	public Q00063_PathOfTheWarder()
	{
		...
		StartNpcs(MASTER_SIONE);
		TalkNpcs(MASTER_SIONE, MASTER_GOBIE, MASTER_TOBIAS, CAPTAIN_BATHIS);
		KillNpcs(OL_MAHUM_PATROL, OL_MAHUM_NOVICE, MAILLE_LIZARDMAN, MAILLE_LIZARDMAN_SCOUT, MAILLE_LIZARDMAN_GUARD, OL_MAHUM_OFFICER_TAK);
			...
			switch (npc.getNpcId())
			{
				...
				case MAILLE_LIZARDMAN_GUARD:
				{
					if (qs.isMemoState(16) && !hasQuestItems(killer, TAKS_CAPTURED_SOUL))
					{
						...
						{
							qs.set("ex", 0);
							final L2Attackable monster = (L2Attackable) addSpawn(OL_MAHUM_OFFICER_TAK, npc);
