...
public final class Q00104_SpiritOfMirrors extends Quest
{
	...
	public Q00104_SpiritOfMirrors()
	{
		...
		StartNpcs(GALLINT);
		TalkNpcs(ARNOLD, GALLINT, JOHNSTONE, KENYOS);
					...
					switch (st.getState())
					{
						...
						case State.STARTED:
						{
							if (st.isCond(3) && st.hasQuestItems(SPIRITBOUND_WAND1, SPIRITBOUND_WAND2, SPIRITBOUND_WAND3))
							{
								...
								player.sendPacket(new ExShowScreenMessage("Acquisition of race specific weapon complete, go find the Newbie Guide", 5000));
