...
public class Q00255_Tutorial extends Quest
{
	...
	public static final Map<Integer, String> QMCb = new HashMap<>();
	
	// table for Question Mark Clicked (35) 1st class transfer [raceId, html]
	public static final Map<Integer, String> QMCc = new HashMap<>();
	
	// table for Tutorial Close Link (26) 2nd class transfer [raceId, html]
	public static final Map<Integer, String> TCLa = new HashMap<>();
	
	// table for Tutorial Close Link (23) 2nd class transfer [raceId, html]
	public static final Map<Integer, String> TCLb = new HashMap<>();
	
	// table for Tutorial Close Link (24) 2nd class transfer [raceId, html]
	public static final Map<Integer, String> TCLc = new HashMap<>();
	...
	{
		super(255, Q00255_Tutorial.class.getSimpleName(), "");
	}
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		QuestState st = player.getQuestState(Q00255_Tutorial.class.getSimpleName());
		...
		if (event.startsWith("UC"))
		{
			...
			else if ((level == 18) && (player.getQuestState(Q10276_MutatedKaneusGludio.class.getSimpleName()) == null))
			{
				st.showQuestionMark(36);
				st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
			}
			else if ((level == 28) && (player.getQuestState(Q10277_MutatedKaneusDion.class.getSimpleName()) == null))
			{
				st.showQuestionMark(36);
				st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
			}
			else if ((level == 28) && (player.getQuestState(Q10278_MutatedKaneusHeine.class.getSimpleName()) == null))
			{
				st.showQuestionMark(36);
				st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
			}
			else if ((level == 28) && (player.getQuestState(Q10279_MutatedKaneusOren.class.getSimpleName()) == null))
			{
				st.showQuestionMark(36);
				st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
			}
			else if ((level == 28) && (player.getQuestState(Q10280_MutatedKaneusSchuttgart.class.getSimpleName()) == null))
			{
				st.showQuestionMark(36);
				st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
			}
			else if ((level == 28) && (player.getQuestState(Q10281_MutatedKaneusRune.class.getSimpleName()) == null))
			{
				st.showQuestionMark(36);
				st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
			}
			else if ((level == 79) && (player.getQuestState(Q00192_SevenSignsSeriesOfDoubt.class.getSimpleName()) == null))
			{
				st.showQuestionMark(36);
				st.playSound(QuestSound.ITEMSOUND_QUEST_TUTORIAL);
			}
