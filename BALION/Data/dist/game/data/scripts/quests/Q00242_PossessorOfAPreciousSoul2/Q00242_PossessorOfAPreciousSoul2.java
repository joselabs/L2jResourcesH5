...
public class Q00242_PossessorOfAPreciousSoul2 extends Quest
{
	...
	// SKill
	private static SkillHolder SKILL = new SkillHolder(4546, 1);
	
	public Q00242_PossessorOfAPreciousSoul2()
	{
		super(242, Q00242_PossessorOfAPreciousSoul2.class.getSimpleName(), "");
		StartNpcs(VIRGIL);
		TalkNpcs(VIRGIL, KASSANDRA, OGMAR, MYSTERIOUS_KNIGHT, ANGEL_CORPSE, KALIS, MATILD, FALLEN_UNICORN, CORNERSTONE, PURE_UNICORN);
		KillNpcs(RESTRAINER_OF_GLORY);
