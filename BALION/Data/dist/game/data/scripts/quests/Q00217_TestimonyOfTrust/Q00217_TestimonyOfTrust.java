...
public final class Q00217_TestimonyOfTrust extends Quest
{
	...
	public Q00217_TestimonyOfTrust()
	{
		...
		StartNpcs(HIGH_PRIEST_HOLLINT);
		TalkNpcs(HIGH_PRIEST_HOLLINT, HIGH_PRIEST_BIOTIN, HIERARCH_ASTERIOS, TETRARCH_THIFIELL, MAGISTER_CLAYTON, SEER_MANAKIA, IRON_GATES_LOCKIRIN, FLAME_LORD_KAKAI, MAESTRO_NIKOLA, CARDINAL_SERESIN);
		KillNpcs(DRYAD, DRYAD_ELDER, LIREIN, LIREIN_ELDER, ANT_RECRUIT, ANT_PATROL, ANT_GUARD, ANT_SOLDIER, ANT_WARRIOR_CAPTAIN, MARSH_STAKATO, PORTA, MARSH_STAKATO_WORKER, MARSH_STAKATO_SOLDIER, MARSH_STAKATO_DRONE, GUARDIAN_BASILISK, WINDSUS, LUELL_OF_ZEPHYR_WINDS, ACTEA_OF_VERDANT_WILDS);
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (qs.isCreated())
		{
			if (npc.getNpcId() == HIGH_PRIEST_HOLLINT)
			{
				if ((player.getRace() == Race.Human) && (player.getLevel() >= MIN_LEVEL))
				{
					if ((player.getClassId().getId() == 1) || (player.getClassId().getId() == 4) || (player.getClassId().getId() == 7) || (player.getClassId().getId() == 11) || (player.getClassId().getId() == 15))
					{
				...
				{
					if ((player.getClassId().getId() == 0) || (player.getClassId().getId() == 10) || (player.getClassId().getId() == 18) || (player.getClassId().getId() == 25) || (player.getClassId().getId() == 31) || (player.getClassId().getId() == 38) || (player.getClassId().getId() == 44) || (player.getClassId().getId() == 49) || (player.getClassId().getId() == 53) || (player.getClassId().getId() == 123) || (player.getClassId().getId() == 124))
					{
