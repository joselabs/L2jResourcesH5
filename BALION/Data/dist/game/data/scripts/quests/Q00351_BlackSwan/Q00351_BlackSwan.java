...
public final class Q00351_BlackSwan extends Quest
{
	...
	public Q00351_BlackSwan()
	{
		...
		StartNpcs(GOSTA, ROMAN);
		TalkNpcs(GOSTA, IASON_HEINE, ROMAN);
		KillNpcs(TASABA_LIZARDMAN1, TASABA_LIZARDMAN_SHAMAN1, TASABA_LIZARDMAN2, TASABA_LIZARDMAN_SHAMAN2);
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		else if (getRandom(100) < MONSTER_DROP_CHANCES.get(npc.getNpcId()))
		{
