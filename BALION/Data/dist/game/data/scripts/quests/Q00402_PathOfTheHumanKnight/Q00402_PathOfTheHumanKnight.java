...
public final class Q00402_PathOfTheHumanKnight extends Quest
{
	...
	public Q00402_PathOfTheHumanKnight()
	{
		...
		StartNpcs(SIR_KLAUS_VASPER);
		TalkNpcs(SIR_KLAUS_VASPER, HIGH_PRIEST_BIOTIN, LEVIAN, HIGH_PRIEST_RAYMOND, CAPTAIN_GILBERT, CAPTAIN_BATHIS, CAPTAIN_BEZIQUE, SIR_ARON_TANFORD);
		KillNpcs(LANGK_LIZARDMAN_WARRIOR, LANGK_LIZARDMAN_SCOUT, LANGK_LIZARDMAN, VENOMOUS_SPIDER, ARACHNID_TRACKER, ARACHNID_PREDATOR, GIANT_SPIDER, TALON_SPIDER, BLADE_SPIDER, SILENT_HORROR, BUGBEAR_RAIDER, UNDEAD_PRIEST);
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		{
			if (npc.getNpcId() == SIR_KLAUS_VASPER)
			{
