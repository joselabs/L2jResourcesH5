...
public final class Q00343_UnderTheShadowOfTheIvoryTower extends Quest
{
	...
	public Q00343_UnderTheShadowOfTheIvoryTower()
	{
		...
		StartNpcs(MAGIC_TRADER_CEMA);
		TalkNpcs(MAGIC_TRADER_CEMA, LICH_KING_ICARUS, COLLECTOR_MARSHA, COLLECTOR_TRUMPIN);
		KillNpcs(MANASHEN_GARGOYLE, ENCHANTED_MONSTEREYE, ENCHANTED_STONE_GOLEM, ENCHANTED_IRON_GOLEM);
	}
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (event)
		{
			...
			case "30834-04.htm":
			{
				...
				{
					if ((player.getClassId().getId() == 10) || // <!-- Human Mystic -->
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (qs.isCreated())
		{
			if (npc.getNpcId() == MAGIC_TRADER_CEMA)
			{
				if ((player.getClassId().getId() == 10) || // <!-- Human Mystic -->
					(player.getClassId().getId() == 11) || // <!-- Human Wizard -->
					(player.getClassId().getId() == 12) || // <!-- Sorcerer -->
