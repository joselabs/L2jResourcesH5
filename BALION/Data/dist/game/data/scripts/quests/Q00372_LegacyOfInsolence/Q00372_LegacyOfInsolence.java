...
public final class Q00372_LegacyOfInsolence extends Quest
{
	...
	public Q00372_LegacyOfInsolence()
	{
		...
		StartNpcs(WAREHOUSE_KEEPER_WALDERAL);
		TalkNpcs(WAREHOUSE_KEEPER_WALDERAL, TRADER_HOLLY, MAGISTER_DESMOND, ANTIQUE_DEALER_PATRIN, CLAUDIA_ATHEBALDT);
		KillNpcs(MONSTER_REWARDS.keySet());
	}
	...
	{
		final QuestItemHolder item = MONSTER_REWARDS.get(npc.getNpcId());
		if (npc.getNpcId() == HALLATES_INSPECTOR)
		{
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (qs.isCreated())
		{
			if (npc.getNpcId() == WAREHOUSE_KEEPER_WALDERAL)
			{
