...
public final class Q00108_JumbleTumbleDiamondFuss extends Quest
{
	...
	public Q00108_JumbleTumbleDiamondFuss()
	{
		...
		StartNpcs(COLLECTOR_GOUPH);
		TalkNpcs(COLLECTOR_GOUPH, TRADER_REEP, CARRIER_TOROCCO, MINER_MARON, BLACKSMITH_BRUNON, WAREHOUSE_KEEPER_MURDOC, WAREHOUSE_KEEPER_AIRY);
		KillNpcs(GOBLIN_BRIGAND_LEADER, GOBLIN_BRIGAND_LIEUTENANT, BLADE_BAT);
						...
						switch (st.getCond())
						{
							...
							case 12:
							{
								if (st.hasQuestItems(STAR_DIAMOND))
								{
									...
									talker.sendPacket(new ExShowScreenMessage("Acquisition of race specific weapon complete, go find the Newbie Guide", 5000));
