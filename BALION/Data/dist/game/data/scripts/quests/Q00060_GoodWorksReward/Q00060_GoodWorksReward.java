...
public final class Q00060_GoodWorksReward extends Quest
{
	...
	public Q00060_GoodWorksReward()
	{
		...
		StartNpcs(BLUEPRINT_SELLER_DAEGER);
		TalkNpcs(BLUEPRINT_SELLER_DAEGER, GROCER_HELVERIA, BLACK_MARKETEER_OF_MAMMON, MARK);
		KillNpcs(PURSUER);
		SpawnNpcs(PURSUER);
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		{
			npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "You have good luck. I shall return."));
		...
		switch (event)
		{
			...
			case "REPLY_5":// SECOND_CLASS_GROUP
			{
				if ((player.getClassId().getId() == 1) || (player.getClassId().getId() == 4) || (player.getClassId().getId() == 7) || (player.getClassId().getId() == 11) || (player.getClassId().getId() == 15) || (player.getClassId().getId() == 19) || (player.getClassId().getId() == 22) || (player.getClassId().getId() == 26) || (player.getClassId().getId() == 29) || (player.getClassId().getId() == 32) || (player.getClassId().getId() == 35) || (player.getClassId().getId() == 39) || (player.getClassId().getId() == 42) || (player.getClassId().getId() == 45) || (player.getClassId().getId() == 47) || (player.getClassId().getId() == 50) || (player.getClassId().getId() == 54) || (player.getClassId().getId() == 56) || (player.getClassId().getId() == 125) || (player.getClassId().getId() == 126))
				{
					switch (player.getClassId())
					{
						case warrior:
			...
			if (qs.isMemoState(1))
			{
				if (killer.isPlayer())
				{
					if (killer.getObjectId() == npc.getVariables().getInt("PLAYER_ID", 0))
					{
						qs.setMemoState(2);
						qs.setCond(2, true);
						npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "You are strong. This was a mistake."));
					}
					else
					{
						npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "Who are you to join in the battle? How upsetting."));
					}
				}
			}
			final L2Npc npc0 = npc.getVariables().getObject("npc0", L2Npc.class);
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (qs.isCreated())
		{
			if (npc.getNpcId() == BLUEPRINT_SELLER_DAEGER)
			{
		...
		else if (qs.isCompleted())
		{
			...
			else if (npc.getNpcId() == BLACK_MARKETEER_OF_MAMMON)
			{
				if ((player.getClassId().getId() == 1) || (player.getClassId().getId() == 4) || (player.getClassId().getId() == 7) || (player.getClassId().getId() == 11) || (player.getClassId().getId() == 15) || (player.getClassId().getId() == 19) || (player.getClassId().getId() == 22) || (player.getClassId().getId() == 26) || (player.getClassId().getId() == 29) || (player.getClassId().getId() == 32) || (player.getClassId().getId() == 35) || (player.getClassId().getId() == 39) || (player.getClassId().getId() == 42) || (player.getClassId().getId() == 45) || (player.getClassId().getId() == 47) || (player.getClassId().getId() == 50) || (player.getClassId().getId() == 54) || (player.getClassId().getId() == 56) || (player.getClassId().getId() == 125) || (player.getClassId().getId() == 126))
				{
	...
	public String onSpawn(L2Npc npc)
	{
		...
		if (player != null)
		{
			if (player.isPlayer())
			{
				npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), player.getName() + "! I must kill you. Blame your own curiosity."));
			}
		}
