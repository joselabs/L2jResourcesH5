...
public final class Q00299_GatherIngredientsForPie extends Quest
{
	...
	public Q00299_GatherIngredientsForPie()
	{
		...
		StartNpcs(EMILLY);
		TalkNpcs(LARS, BRIGHT, EMILLY);
		KillNpcs(MONSTERS_CHANCES.keySet());
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		if ((qs != null) && (getRandom(1000) < MONSTERS_CHANCES.get(npc.getNpcId())) && (getQuestItemsCount(killer, HONEY_POUCH) < 100))
		{
