...
public class Q00194_SevenSignsMammonsContract extends Quest
{
	...
	public Q00194_SevenSignsMammonsContract()
	{
		...
		StartNpcs(SIR_GUSTAV_ATHEBALDT);
		TalkNpcs(SIR_GUSTAV_ATHEBALDT, COLIN, FROG, TESS, KUTA, CLAUDIA_ATHEBALDT);
		...
		switch (event)
		{
			...
			case "31001-03.html":
			{
				if (st.isCond(12))
				{
					...
					{
						st.addExpAndSp(Config.SSQ194E_52518015, Config.SSQ194SP_5817677);
