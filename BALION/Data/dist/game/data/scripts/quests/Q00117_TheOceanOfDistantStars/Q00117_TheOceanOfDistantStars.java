...
public final class Q00117_TheOceanOfDistantStars extends Quest
{
	...
	public Q00117_TheOceanOfDistantStars()
	{
		...
		StartNpcs(ABEY);
		TalkNpcs(ABEY, GHOST_OF_A_RAILROAD_ENGINEER, GHOST_OF_AN_ANCIENT_RAILROAD_ENGINEER, BOX, OBI);
		KillNpcs(BANDIT_WARRIOR, BANDIT_INSPECTOR);
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		if (giveItemRandomly(killer, npc, BOOK_OF_GREY_STAR, 1, 1, MONSTER_DROP_CHANCES.get(npc.getNpcId()), true))
		{
			qs.setCond(8);
		}
