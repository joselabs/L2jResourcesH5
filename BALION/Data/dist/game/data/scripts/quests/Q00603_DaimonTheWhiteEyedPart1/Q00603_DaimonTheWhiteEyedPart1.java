...
public final class Q00603_DaimonTheWhiteEyedPart1 extends Quest
{
	...
	public Q00603_DaimonTheWhiteEyedPart1()
	{
		...
		TalkNpcs(EYE_OF_ARGOS, TABLET_1, TABLET_2, TABLET_3, TABLET_4, TABLET_5);
		KillNpcs(MONSTER_CHANCES.keySet());
	...
	public String onTalk(L2Npc npc, L2PcInstance talker)
	{
		...
		switch (qs.getState())
		{
			...
			case State.STARTED:
			{
				...
				else if (qs.getInt("TABLET_" + npc.getNpcId()) == 0)
				{
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		if (qs != null)
		{
			if (giveItemRandomly(qs.getPlayer(), npc, SPIRIT_OF_DARKNESS, 1, 200, MONSTER_CHANCES.get(npc.getNpcId()), true))
			{
				qs.setCond(8, true);
			}
		}
