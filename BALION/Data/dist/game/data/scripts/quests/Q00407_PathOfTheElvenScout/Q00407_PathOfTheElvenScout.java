...
public final class Q00407_PathOfTheElvenScout extends Quest
{
	...
	public Q00407_PathOfTheElvenScout()
	{
		...
		StartNpcs(MASTER_REORIA);
		TalkNpcs(MASTER_REORIA, GUARD_BABENCO, GUARD_MORETTI, PRIAS);
		KillNpcs(OL_MAHUM_PATROL, OL_MAHUM_SENTRY);
		AttackNpcs(OL_MAHUM_PATROL, OL_MAHUM_SENTRY);
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		if (npc.isScriptValue(killer.getObjectId()) && Util.checkIfInRange(1500, npc, killer, false))
		{
			...
			if (npc.getNpcId() == OL_MAHUM_SENTRY)
			{
