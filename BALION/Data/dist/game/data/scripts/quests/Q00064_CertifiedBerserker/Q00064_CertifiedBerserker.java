...
public final class Q00064_CertifiedBerserker extends Quest
{
	...
	public Q00064_CertifiedBerserker()
	{
		...
		StartNpcs(MASTER_ORKURUS);
		TalkNpcs(MASTER_ORKURUS, MASTER_ENTIENS, MASTER_TENAIN, CARAVANER_GORT, HARKILGAMED);
		KillNpcs(DEAD_SEEKER, MARSH_STAKATO_DRONE, BREKA_ORC, BREKA_ORC_ARCHER, BREKA_ORC_SHAMAN, BREKA_ORC_OVERLORD, BREKA_ORC_WARRIOR, ROAD_SCAVENGER, DIVINE_EMISSARY);
				...
				case DIVINE_EMISSARY:
				{
					if (qs.isMemoState(9))
					{
						if (getRandom(100) < 20)
						{
							...
							kamael.broadcastPacket(new CreatureSay(kamael.getObjectId(), 1, kamael.getName(), killer.getName() + ", did you come to help me?"));
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (qs.isCreated())
		{
			if (npc.getNpcId() == MASTER_ORKURUS)
			{
