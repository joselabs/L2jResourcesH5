...
public final class Q00604_DaimonTheWhiteEyedPart2 extends Quest
{
	...
	public Q00604_DaimonTheWhiteEyedPart2()
	{
		...
		StartNpcs(EYE_OF_ARGOS);
		TalkNpcs(EYE_OF_ARGOS, DAIMONS_ALTAR);
		SpawnNpcs(DAIMON_THE_WHITE_EYED);
		KillNpcs(DAIMON_THE_WHITE_EYED);
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		if ("DESPAWN".equals(event))
		{
			if (isDaimonSpawned())
			{
				npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "Can light exist without darkness?"));
				npc.deleteMe();
			}
	...
	public String onSpawn(L2Npc npc)
	{
		...
		npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "Who is calling me?"));
