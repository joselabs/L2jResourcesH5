...
public final class Q00286_FabulousFeathers extends Quest
{
	...
	public Q00286_FabulousFeathers()
	{
		...
		StartNpcs(ERINU);
		TalkNpcs(ERINU);
		KillNpcs(MOB_DROP_CHANCES.keySet());
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		if (qs != null)
		{
			if (giveItemRandomly(qs.getPlayer(), npc, COMMANDERS_FEATHER.getId(), 1, COMMANDERS_FEATHER.getCount(), MOB_DROP_CHANCES.get(npc.getNpcId()), true))
			{
				qs.setCond(2);
			}
		}
