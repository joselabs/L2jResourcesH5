...
/**
 ** @author Gnacik 2010-08-19 Based on Freya PTS
 */
public class Q00463_IMustBeaGenius extends Quest
{
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		if ((st.getState() == State.STARTED) && (st.getInt("cond") == 1) && Util.contains(_mobs, npc.getNpcId()))
		{
			...
			if (_number > 0)
			{
				...
				npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "Att... attack... " + player.getName() + " .. Ro... rogue... " + String.valueOf(_number) + ".."));
			}
	...
	public Q00463_IMustBeaGenius()
	{
		...
		StartNpcs(_gutenhagen);
		TalkNpcs(_gutenhagen);
		for (int _mob : _mobs)
		{
			KillNpcs(_mob);
		}
