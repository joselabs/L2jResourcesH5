...
public class Q00241_PossessorOfAPreciousSoul1 extends Quest
{
	...
	{
		super(241, Q00241_PossessorOfAPreciousSoul1.class.getSimpleName(), "Possessor of a Precious Soul");
		StartNpcs(_talien);
		TalkNpcs(NPCS);
		KillNpcs(MOBS);
	}
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		QuestState st = player.getQuestState(Q00241_PossessorOfAPreciousSoul1.class.getSimpleName());
	...
	public String onTalk(L2Npc npc, L2PcInstance talker)
	{
		...
		QuestState st = talker.getQuestState(Q00241_PossessorOfAPreciousSoul1.class.getSimpleName());
		...
		if (npcId == _talien)
		{
			if (cond == 0)
			{
				...
				else if ((talker.getLevel() >= 50) && talker.isSubClassActive())
				{
		...
		else if (talker.isSubClassActive())
		{
			switch (npcId)
			{
				case _gabrielle:
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isPet)
	{
		switch (npc.getNpcId())
		{
			case _baraham:
			{
				...
				if (ptMember != null)
				{
					QuestState st = ptMember.getQuestState(Q00241_PossessorOfAPreciousSoul1.class.getSimpleName());
					st.set("cond", "4");
