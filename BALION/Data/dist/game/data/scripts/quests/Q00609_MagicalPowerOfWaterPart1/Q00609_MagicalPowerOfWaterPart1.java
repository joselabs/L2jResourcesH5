...
public class Q00609_MagicalPowerOfWaterPart1 extends Quest
{
	...
	public Q00609_MagicalPowerOfWaterPart1()
	{
		...
		StartNpcs(WAHKAN);
		TalkNpcs(ASEFA, WAHKAN, UDANS_BOX);
		AttackNpcs(VARKA_MOBS);
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (event)
		{
			...
			case "open_box":
				...
				break;
			case "eye_despawn":
				npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "Udan has already seen your face!"));
				npc.deleteMe();
				break;
		}
		return htmltext;
	...
	public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isSummon)
	{
		...
		if ((st != null) && st.isCond(2) && !st.isSet("spawned"))
		{
			...
			eye.broadcastPacket(new CreatureSay(eye.getObjectId(), 1, eye.getName(), "You can't avoid the eyes of Udan!"));
