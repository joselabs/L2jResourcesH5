...
public final class Q00228_TestOfMagus extends Quest
{
	...
	public Q00228_TestOfMagus()
	{
		...
		StartNpcs(BARD_RUKAL);
		TalkNpcs(BARD_RUKAL, PARINA, EARTH_SNAKE, FLAME_SALAMANDER, WIND_SYLPH, WATER_UNDINE, ELDER_CASIAN);
		KillNpcs(HARPY, MARSH_STAKATO, WYRM, MARSH_STAKATO_WORKER, TOAD_LORD, MARSH_STAKATO_SOLDIER, MARSH_STAKATO_DRONE, WINDSUS, ENCHANTED_MONSTEREYE, ENCHANTED_STOLEN_GOLEM, ENCHANTED_IRON_GOLEM, SINGING_FLOWER_PHANTASM, SINGING_FLOWER_NIGTMATE, SINGING_FLOWER_DARKLING, GHOST_FIRE);
			...
			switch (npc.getNpcId())
			{
				...
				case SINGING_FLOWER_PHANTASM:
				{
					if (hasQuestItems(killer, LILAC_CHARM) && !hasQuestItems(killer, GOLDEN_SEED_1ST))
					{
						...
						npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "I am a tree of nothing... a tree... that knows where to return..."));
						playSound(killer, QuestSound.ITEMSOUND_QUEST_MIDDLE);
				...
				case SINGING_FLOWER_NIGTMATE:
				{
					if (hasQuestItems(killer, LILAC_CHARM) && !hasQuestItems(killer, GOLDEN_SEED_2ND))
					{
						...
						npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "I am a creature that shows the truth of the place deep in my heart..."));
						playSound(killer, QuestSound.ITEMSOUND_QUEST_MIDDLE);
				...
				case SINGING_FLOWER_DARKLING:
				{
					if (hasQuestItems(killer, LILAC_CHARM) && !hasQuestItems(killer, GOLDEN_SEED_3RD))
					{
						...
						npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "I am a mirror of darkness... a virtual image of darkness..."));
						playSound(killer, QuestSound.ITEMSOUND_QUEST_MIDDLE);
