...
public final class Q00418_PathOfTheArtisan extends Quest
{
	...
	public Q00418_PathOfTheArtisan()
	{
		...
		StartNpcs(BLACKSMITH_SILVERA);
		TalkNpcs(BLACKSMITH_SILVERA, BLACKSMITH_PINTER, BLACKSMITH_KLUTO, IRON_GATES_LOCKIRIN, WAREHOUSE_KEEPER_RYDEL, MINERAL_TRADER_HITCHI, RAILROAD_WORKER_OBI);
		KillNpcs(VUKU_ORC_FIGHTER, BOOGLE_RATMAN, BOOGLE_RATMAN_LEADER);
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		{
			if (npc.getNpcId() == BLACKSMITH_SILVERA)
			{
