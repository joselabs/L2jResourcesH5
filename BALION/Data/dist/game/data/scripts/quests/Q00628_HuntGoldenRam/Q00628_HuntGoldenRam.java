...
public final class Q00628_HuntGoldenRam extends Quest
{
	...
	{
		super(628, Q00628_HuntGoldenRam.class.getSimpleName(), "Hunt Golden Ram");
		StartNpcs(KAHMAN);
		TalkNpcs(KAHMAN, SELINA);
		FirstTalkNpcs(ABERCROMBIE, SELINA);
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		{
			final QuestItemHolder item = MOBS_DROP_CHANCES.get(npc.getNpcId());
