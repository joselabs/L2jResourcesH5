...
public final class Q00382_KailsMagicCoin extends Quest
{
	...
	public Q00382_KailsMagicCoin()
	{
		...
		StartNpcs(VERGARA);
		TalkNpcs(VERGARA);
		KillNpcs(FALLEN_ORC, FALLEN_ORC_ARCHER, FALLEN_ORC_SHAMAN, FALLEN_ORC_CAPTAIN);
	}
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		{
			if (npc.getNpcId() == FALLEN_ORC_CAPTAIN)
			{
				giveItemRandomly(killer, KAILS_SILVER_BASILISK + getRandom(3), 1, 0, ORC_CAPTAIN_DROP_CHANCE, true);
			}
			else
			{
				final ItemChanceHolder ih = MONSTER_DROPS.get(npc.getNpcId());
