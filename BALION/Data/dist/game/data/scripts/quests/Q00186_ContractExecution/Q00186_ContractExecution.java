...
public final class Q00186_ContractExecution extends Quest
{
	...
	public Q00186_ContractExecution()
	{
		...
		StartNpcs(RESEARCHER_LORAIN);
		TalkNpcs(RESEARCHER_LORAIN, BLUEPRINT_SELLER_LUKA, MAESTRO_NIKOLA);
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		if ((qs != null) && qs.isMemoState(2) && Util.checkIfInRange(1500, npc, killer, false) && (getRandom(100) < MONSTERS.get(npc.getNpcId())))
		{
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (qs.isCreated())
		{
			if (npc.getNpcId() == RESEARCHER_LORAIN)
			{
