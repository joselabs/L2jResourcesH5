...
public class Q00195_SevenSignsSecretRitualOfThePriests extends Quest
{
	...
	public Q00195_SevenSignsSecretRitualOfThePriests()
	{
		...
		FirstTalkNpcs(IDENTITY_CONFIRM_DEVICE, PASSWORD_ENTRY_DEVICE, DARKNESS_OF_DAWN, SHELF);
		StartNpcs(CLAUDIA_ATHEBALDT);
		TalkNpcs(CLAUDIA_ATHEBALDT, JOHN, RAYMOND, IASON_HEINE, LIGHT_OF_DAWN, DARKNESS_OF_DAWN, IDENTITY_CONFIRM_DEVICE, PASSWORD_ENTRY_DEVICE, SHELF);
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (event)
		{
			...
			case "30969-03.html":
			{
				if (st.isCond(4) && st.hasQuestItems(SHUNAIMANS_CONTRACT))
				{
					st.addExpAndSp(Config.SSQ195E_52518015, Config.SSQ195SP_5817677);
