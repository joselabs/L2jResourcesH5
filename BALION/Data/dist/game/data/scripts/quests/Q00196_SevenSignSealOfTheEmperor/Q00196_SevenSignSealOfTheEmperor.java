...
public class Q00196_SevenSignSealOfTheEmperor extends Quest
{
	...
	public Q00196_SevenSignSealOfTheEmperor()
	{
		super(196, Q00196_SevenSignSealOfTheEmperor.class.getSimpleName(), "Seven Signs, Seal of the Emperor");
		StartNpcs(HEINE);
		TalkNpcs(NPCS);
		SkillSeeNpcs(SEALDEVICE);
		AttackNpcs(SEALDEVICE);
		KillNpcs(TOKILL);
		AttackNpcs(LILITH, LILITH_GUARD0, LILITH_GUARD1, ANAKIM, ANAKIM_GUARD0, ANAKIM_GUARD1, ANAKIM_GUARD2);
		AggroRangeEnterNpcs(TOCHAT);
		registerQuestItems(SWORD, WATER, SEAL, STAFF);
	}
	...
	public String onAggroRangeEnter(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		{
			if ((npc.getNpcId() == 27371) || (npc.getNpcId() == 27372) || (npc.getNpcId() == 27373) || (npc.getNpcId() == 27379) || (npc.getNpcId() == 27377) || (npc.getNpcId() == 27378))
			{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (event)
		{
			...
			case "32593-02.htm":
				...
				{
					st.addExpAndSp(Config.SSQ196E_52518015, Config.SSQ196SP_5817677);
					st.unset("cond");
				...
				{
					player.sendMessage("You level is too low for receive rewards.");
				}
				break;
			case "30969-06.htm":
				if (mammonst == 0)
				{
					...
					mammon.broadcastPacket(new CreatureSay(mammon.getObjectId(), 1, mammon.getName(), "Who dares summon the Merchant of Mammon?"));
