...
public final class Q00413_PathOfTheShillienOracle extends Quest
{
	...
	public Q00413_PathOfTheShillienOracle()
	{
		...
		StartNpcs(MAGISTER_SIDRA);
		TalkNpcs(MAGISTER_SIDRA, PRIEST_ADONIUS, MAGISTER_TALBOT);
		KillNpcs(ZOMBIE_SOLDIER, ZOMBIE_WARRIOR, SHIELD_SKELETON, SKELETON_INFANTRYMAN, DARK_SUCCUBUS);
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		{
			if (npc.getNpcId() == MAGISTER_SIDRA)
			{
