...
public class Q00114_ResurrectionOfAnOldManager extends Quest
{
	...
	public Q00114_ResurrectionOfAnOldManager()
	{
		...
		StartNpcs(YUMI);
		TalkNpcs(YUMI, WENDY, BOX, STONES, NEWYEAR);
		KillNpcs(GUARDIAN);
		SeeCreatureNpcs(STONES);
		...
		switch (event)
		{
			...
			case "32047-15b.html":
				if ((golem == null) || ((golem != null) && golem.isDead()))
				{
					...
					golem.broadcastPacket(new CreatureSay(golem.getObjectId(), 1, golem.getName(), "You, " + player.getName() + ", you attacked Wendy. Prepare to die!"));
					golem.setRunning();
			...
			case "golem_despawn":
				st.unset("spawned");
				golem.broadcastPacket(new CreatureSay(golem.getObjectId(), 1, golem.getName(), player.getName() + ", your enemy was driven out. I will now withdraw and await your next command."));
				golem.deleteMe();
				golem = null;
				htmltext = null;
				break;
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isSummon)
	{
		...
		{
			npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "This enemy is far too powerful for me to fight. I must withdraw."));
			st.setCond(11, true);
			st.unset("spawned");
	...
	public String onSeeCreature(L2Npc npc, L2Character creature, boolean isSummon)
	{
		if (creature.isPlayer())
		{
			...
			if ((st != null) && st.isCond(17))
			{
				...
				st.setCond(18, true);
				creature.sendPacket(new ExShowScreenMessage("The radio signal detector is responding a suspicious pile of stones, catches your eyes!", 4500));
			}
		}
