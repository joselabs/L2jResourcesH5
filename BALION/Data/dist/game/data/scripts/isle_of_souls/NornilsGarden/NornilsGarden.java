 ...
 */
package isle_of_souls.NornilsGarden;
...
public class NornilsGarden extends Quest
{
	...
	{
		QuestState st = player.getQuestState(NornilsGarden.class.getSimpleName());
		if (st == null)
		{
			Quest q = QuestManager.getInstance().getQuest(NornilsGarden.class.getSimpleName());
	...
	private static final String checkConditions(L2Npc npc, L2PcInstance player)
	{
		...
		for (L2PcInstance partyMember : party.getPartyMembers())
		{
			...
			{
				QuestState checkst = partyMember.getQuestState(Q179_IntoTheLargeCavern.class.getSimpleName());
	...
	public final String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		{
			QuestState cst = player.getQuestState(Q179_IntoTheLargeCavern.class.getSimpleName());
	...
	{
		super(-1, NornilsGarden.class.getSimpleName(), "isle_of_souls");
		
		StartNpcs(_garden_guard);
		FirstTalkNpcs(_garden_guard);
		TalkNpcs(_garden_guard);
		...
		AttackNpcs(_herb_jar);
		AttackNpcs(18362); // first garden guard
	}
}