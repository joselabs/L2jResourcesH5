...
{
	protected class ZWorld extends InstanceWorld
	{
		...
		L2Character _target;
		L2Attackable _zaken;
		L2Npc _barel1, _barel2, _barel3, _barel4, _barel5, _barel6, _barel7, _barel8, _barel9, _barel10, _barel11, _barel12, _barel13, _barel14, _barel15, _barel16, _barel17, _barel18, _barel19, _barel20, _barel21, _barel22, _barel23, _barel24, _barel25, _barel26, _barel27, _barel28, _barel29,
			_barel30, _barel31, _barel32, _barel33, _barel34, _barel35, _barel36, _zakenBarel1, _zakenBarel2, _zakenBarel3, _zakenBarel4;
	...
	{
		_room4_zone,_room4_zone,_room3_zone,_room1_zone,
		_room3_zone,_room3_zone,_room5_zone,_room5_zone,
		_room3_zone,_room2_zone,_room2_zone,_room1_zone,
		_room9_zone,_room9_zone,_room8_zone,_room6_zone,
		_room8_zone,_room8_zone,_room10_zone,_room10_zone,
		_room8_zone,_room7_zone,_room7_zone,_room6_zone,
		_room14_zone,_room14_zone,_room13_zone,_room11_zone,
		_room13_zone,_room13_zone,_room15_zone,_room15_zone,
		_room13_zone,_room12_zone,_room12_zone,_room11_zone,
	};
	...
	public Zaken()
	{
		super(-1, Zaken.class.getSimpleName(), "ai");
		
		StartNpcs(PATHFINDER);
		TalkNpcs(PATHFINDER);
		FirstTalkNpcs(PATHFINDER);
		FirstTalkNpcs(BARREL);
	...
	private boolean checkConditions(L2PcInstance player, String choice)
	{
		...
		int maxMembers = Config.MAX_PLAYERS_DAYTIME; // for daytime 27
		...
		{
			case "daytime":
				minLevel = Config.MIN_PLAYERS_LEVEL_DAYTIME;
				break;
			case "daytime83":
				minLevel = Config.MIN_PLAYERS_LEVEL_DAYTIME_STRONG;
				break;
			case "nighttime":
				minMembers = Config.MIN_PLAYERS_NIGHTTIME;
				maxMembers = Config.MAX_PLAYERS_NIGHTTIME;
				break;
		}
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		else if (event.equalsIgnoreCase("nighttime") || event.equalsIgnoreCase("daytime") || event.equalsIgnoreCase("daytime83"))
		{
			...
			if (!DEBUG)
			{
				...
				else if (!party.isInCommandChannel() && (party.getLeader().getObjectId() != player.getObjectId()))
				{
