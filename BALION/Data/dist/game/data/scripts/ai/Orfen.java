...
public class Orfen extends L2AttackableAIScript
{
	...
	{
		"Stop kidding yourself about your own powerlessness!",
		"I'll make you feel what true fear is!",
	...
	public Orfen()
	{
		super(-1, Orfen.class.getSimpleName(), "ai");
		int[] mobs =
		{
			ORFEN,
			RAIKEL_LEOS,
	...
	public void setSpawnPoint(L2Npc npc, int index)
	{
		...
		spawn.setXLocation(Pos[index][0]);
		spawn.setYLocation(Pos[index][1]);
		spawn.setZLocation(Pos[index][2]);
	...
	public String onSkillSee(L2Npc npc, L2PcInstance caster, L2Skill skill, L2Object[] targets, boolean isPet)
	{
		if (npc.getNpcId() == ORFEN)
		{
			...
			{
				npc.sendPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), Text[Rnd.get(4)]));
	...
	public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isPet)
	{
		...
		if (npcId == ORFEN)
		{
			...
			{
				npc.sendPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), Text[Rnd.get(3)]));
