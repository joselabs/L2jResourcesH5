...
public class PcBangPoint extends Quest
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		{
			if ((player.getSummon() == null) || !(player.getSummon() instanceof L2SummonInstance))
			{
		...
		else if (event.equalsIgnoreCase("showme"))
		{
			...
			{
				player.broadcastPacket(new ExShowScreenMessage("Pc Bang Event is disabled", 5000));
			}
		}
	...
	public PcBangPoint()
	{
		super(-1, PcBangPoint.class.getSimpleName(), "ai/npc");
		StartNpcs(NPCs);
		TalkNpcs(NPCs);
	}
}
