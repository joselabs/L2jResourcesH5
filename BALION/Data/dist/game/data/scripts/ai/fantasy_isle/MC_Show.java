...
public class MC_Show extends L2AttackableAIScript
{
	...
	private class ShoutInfo
	{
		...
		public ShoutInfo(String npcStringId, String nextEvent, int time)
		{
	...
	public MC_Show()
	{
		super(-1, MC_Show.class.getSimpleName(), "ai");
	...
	private void autoChat(L2Npc npc, String npcString, int type)
	{
		npc.broadcastPacket(new CreatureSay(npc.getObjectId(), type, npc.getName(), npcString));
	}
