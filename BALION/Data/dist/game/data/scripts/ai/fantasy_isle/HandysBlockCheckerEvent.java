...
public class HandysBlockCheckerEvent extends Quest
{
	...
	{
		super(-1, HandysBlockCheckerEvent.class.getSimpleName(), "ai");
		FirstTalkNpcs(A_MANAGER_1);
		FirstTalkNpcs(A_MANAGER_2);
		FirstTalkNpcs(A_MANAGER_3);
		FirstTalkNpcs(A_MANAGER_4);
	}
}