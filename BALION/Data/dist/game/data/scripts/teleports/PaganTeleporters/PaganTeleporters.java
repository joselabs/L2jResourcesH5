 ...
 * @author Plim
 */
public class PaganTeleporters extends L2AttackableAIScript
{
	// NPCs
	...
	{
		super(-1, PaganTeleporters.class.getSimpleName(), "teleports");
		StartNpcs(NPCS);
		TalkNpcs(NPCS);
		FirstTalkNpcs(TRIOLS_MIRROR_1, TRIOLS_MIRROR_2);
	}
}
