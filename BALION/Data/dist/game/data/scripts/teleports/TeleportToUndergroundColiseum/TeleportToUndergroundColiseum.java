 ...
 */
package teleports.TeleportToUndergroundColiseum;
 ...
 * @author malyelfik
 */
public class TeleportToUndergroundColiseum extends L2AttackableAIScript
{
	// NPCs
	...
	{
		super(-1, TeleportToUndergroundColiseum.class.getSimpleName(), "teleports");
		StartNpcs(MANAGERS);
		StartNpcs(COLISEUM_HELPER, PADDIES);
		FirstTalkNpcs(COLISEUM_HELPER);
		TalkNpcs(MANAGERS);
		TalkNpcs(COLISEUM_HELPER, PADDIES);
	}
}