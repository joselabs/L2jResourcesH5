 ...
 * @author xban1x
 */
public final class Nottingale extends L2AttackableAIScript
{
	// NPC
	...
	public Nottingale()
	{
		super(-1, Nottingale.class.getSimpleName(), "gracia");
		StartNpcs(NOTTINGALE);
		TalkNpcs(NOTTINGALE);
		FirstTalkNpcs(NOTTINGALE);
	}
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (event)
		{
			...
			case "32627-04.html":
			{
				...
				{
					// TODO player.hasClanPrivilege(ClanPrivilege.CL_SUMMON_AIRSHIP) && Really?
					if (AirShipManager.getInstance().hasAirShipLicense(player.getClanId()) && !AirShipManager.getInstance().hasAirShip(player.getClanId()))
					{
						htmltext = event;
					}
					else
