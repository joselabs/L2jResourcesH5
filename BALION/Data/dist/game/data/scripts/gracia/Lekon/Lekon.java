 ...
 * @author St3eT
 */
public final class Lekon extends L2AttackableAIScript
{
	// NPCs
	...
	public Lekon()
	{
		super(-1, Lekon.class.getSimpleName(), "gracia");
		StartNpcs(LEKON);
		FirstTalkNpcs(LEKON);
		TalkNpcs(LEKON);
	}
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		switch (event)
		{
			...
			case "licence":
			{
				...
				else if (AirShipManager.getInstance().hasAirShipLicense(clan.getClanId()))
				{
