...
public class eventmodRabbits extends Event
{
	...
	public eventmodRabbits(int questId, String name, String descr)
	{
		...
		StartNpcs(_npc_snow);
		FirstTalkNpcs(_npc_snow);
		TalkNpcs(_npc_snow);
		
		FirstTalkNpcs(_npc_chest);
		SkillSeeNpcs(_npc_chest);
		SpawnNpcs(_npc_chest);
		AttackNpcs(_npc_chest);
	}
	...
	public boolean eventStart()
	{
		...
		// Schedule Event end
		_eventTask = ThreadPoolManager.getInstance().scheduleGeneral(() -> timeUp(), _event_time * 60 * 1000);
