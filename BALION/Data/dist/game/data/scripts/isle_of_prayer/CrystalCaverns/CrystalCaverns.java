...
package isle_of_prayer.CrystalCaverns;
...
public class CrystalCaverns extends Quest
{
	...
	protected void runDarnel(CCWorld world)
	{
		...
		// Traps
		addSpawn(13045, 152830, 146568, -12585, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152641, 146511, -12585, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152401, 146333, -12585, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152357, 146081, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152191, 145836, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152135, 145525, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152415, 145280, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152691, 145320, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152987, 145485, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 153200, 145749, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 153195, 146050, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 153023, 146076, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 153056, 146269, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 153199, 146592, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 153415, 146595, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 153557, 146336, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 153488, 145933, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 153503, 145495, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 153211, 145151, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152722, 145151, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152232, 145182, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152025, 145639, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152016, 145982, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152285, 146548, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152615, 146492, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152624, 146007, -12588, 21592, false, 0, false, world.getInstanceId());
		addSpawn(13045, 152856, 145974, -12588, 21592, false, 0, false, world.getInstanceId());
		// Doors
	...
	public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isPet, L2Skill skill)
	{
		if (npc.getNpcId() == TEARS)
		{
			...
			if (tmpworld instanceof CCWorld)
			{
				...
				{
					boolean notAOE = true;
					if ((skill != null) && ((skill.getTargetType() == SkillTargetType.TARGET_AREA) || (skill.getTargetType() == SkillTargetType.TARGET_FRONT_AREA) || (skill.getTargetType() == SkillTargetType.TARGET_BEHIND_AREA) || (skill.getTargetType() == SkillTargetType.TARGET_AURA) || (skill.getTargetType() == SkillTargetType.TARGET_FRONT_AURA) || (skill.getTargetType() == SkillTargetType.TARGET_BEHIND_AURA)))
					{
						notAOE = false;
					}
					if (notAOE)
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		if (tmpworld instanceof CCWorld)
		{
			...
			else if (event.equalsIgnoreCase("spawnGuards"))
			{
				...
				L2Npc mob1 = addSpawn(KECHIGUARD, 153622, 149699, -12131, 56890, false, 0, false, world.getInstanceId());
				mob1.getAI().setIntention(CtrlIntention.AI_INTENTION_ATTACK);
				L2Npc mob2 = addSpawn(KECHIGUARD, 153609, 149622, -12131, 64023, false, 0, false, world.getInstanceId());
				mob2.getAI().setIntention(CtrlIntention.AI_INTENTION_ATTACK);
				L2Npc mob3 = addSpawn(KECHIGUARD, 153606, 149428, -12131, 64541, false, 0, false, world.getInstanceId());
				mob3.getAI().setIntention(CtrlIntention.AI_INTENTION_ATTACK);
				L2Npc mob4 = addSpawn(KECHIGUARD, 153601, 149534, -12131, 64901, false, 0, false, world.getInstanceId());
				mob4.getAI().setIntention(CtrlIntention.AI_INTENTION_ATTACK);
				L2Npc mob5 = addSpawn(KECHIGUARD, 153620, 149354, -12131, 1164, false, 0, false, world.getInstanceId());
				mob5.getAI().setIntention(CtrlIntention.AI_INTENTION_ATTACK);
				L2Npc mob6 = addSpawn(KECHIGUARD, 153637, 149776, -12131, 61733, false, 0, false, world.getInstanceId());
				mob6.getAI().setIntention(CtrlIntention.AI_INTENTION_ATTACK);
				L2Npc mob7 = addSpawn(KECHIGUARD, 153638, 149292, -12131, 64071, false, 0, false, world.getInstanceId());
				mob7.getAI().setIntention(CtrlIntention.AI_INTENTION_ATTACK);
				L2Npc mob8 = addSpawn(KECHIGUARD, 153647, 149857, -12131, 59402, false, 0, false, world.getInstanceId());
				mob8.getAI().setIntention(CtrlIntention.AI_INTENTION_ATTACK);
				L2Npc mob9 = addSpawn(KECHIGUARD, 153661, 149227, -12131, 65275, false, 0, false, world.getInstanceId());
				mob9.getAI().setIntention(CtrlIntention.AI_INTENTION_ATTACK);
			...
			else if (event.equalsIgnoreCase("baylorEffect1"))
			{
				...
				L2Npc mob1 = addSpawn(29104, 153756, 142260, -12737, 40286, false, 0, true, world.getInstanceId());
				mob1.getAI().setIntention(CtrlIntention.AI_INTENTION_IDLE);
				world._animationMobs.add(mob1);
				
				L2Npc mob2 = addSpawn(29104, 153853, 142076, -12737, 32541, false, 0, true, world.getInstanceId());
				mob2.getAI().setIntention(CtrlIntention.AI_INTENTION_IDLE);
				world._animationMobs.add(mob2);
				
				L2Npc mob3 = addSpawn(29104, 153756, 141889, -12737, 23347, false, 0, true, world.getInstanceId());
				mob3.getAI().setIntention(CtrlIntention.AI_INTENTION_IDLE);
				world._animationMobs.add(mob3);
				
				L2Npc mob4 = addSpawn(29104, 153572, 141825, -12737, 15681, false, 0, true, world.getInstanceId());
				mob4.getAI().setIntention(CtrlIntention.AI_INTENTION_IDLE);
				world._animationMobs.add(mob4);
				
				L2Npc mob5 = addSpawn(29104, 153386, 141891, -12737, 7280, false, 0, true, world.getInstanceId());
				mob5.getAI().setIntention(CtrlIntention.AI_INTENTION_IDLE);
				world._animationMobs.add(mob5);
				
				L2Npc mob6 = addSpawn(29104, 153318, 142075, -12737, 64464, false, 0, true, world.getInstanceId());
				mob6.getAI().setIntention(CtrlIntention.AI_INTENTION_IDLE);
				world._animationMobs.add(mob6);
				
				L2Npc mob7 = addSpawn(29104, 153392, 142259, -12737, 56760, false, 0, true, world.getInstanceId());
				mob7.getAI().setIntention(CtrlIntention.AI_INTENTION_IDLE);
				world._animationMobs.add(mob7);
				
				L2Npc mob8 = addSpawn(29104, 153573, 142321, -12737, 49002, false, 0, true, world.getInstanceId());
				mob8.getAI().setIntention(CtrlIntention.AI_INTENTION_IDLE);
				world._animationMobs.add(mob8);
	...
	{
		super(-1, CrystalCaverns.class.getSimpleName(), "isle_of_prayer");
		
		StartNpcs(ORACLE_GUIDE_1, ORACLE_GUIDE_4);
		TalkNpcs(ORACLE_GUIDE_1, ORACLE_GUIDE_3, ORACLE_GUIDE_4);
		FirstTalkNpcs(ORACLE_GUIDE_4, CRYSTAL_GOLEM);
		AttackNpcs(TEARS);
		addTrapActionId(DOOR_OPENING_TRAP[0]);
		KillNpcs(TEARS, GK1, GK2, TEROD, WEYLIN, DOLPH, DARNEL, KECHI, GUARDIAN, GUARDIAN2, TOURMALINE, BAYLOR);
		SpellFinishedNpcs(BAYLOR);
		KillNpcs(ALARMID);
		int[] Talk =
		{
			32275,
