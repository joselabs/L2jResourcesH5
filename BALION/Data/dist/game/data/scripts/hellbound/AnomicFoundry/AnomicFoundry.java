...
public class AnomicFoundry extends Quest
{
	...
	{
		super(-1, AnomicFoundry.class.getSimpleName(), "hellbound");
		
		AggroRangeEnterNpcs(LABORER);
		AttackNpcs(LABORER);
		KillNpcs(LABORER, LESSER_EVIL, GREATER_EVIL);
		SpawnNpcs(LABORER, LESSER_EVIL, GREATER_EVIL);
	...
	public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isSummon, L2Skill skill)
	{
		...
		if (atkIndex == 0)
		{
			npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "Enemy invasion! Hurry up!"));
	...
	public String onKill(L2Npc npc, L2PcInstance killer, boolean isSummon)
	{
		...
		else if (npc.getNpcId() == LABORER)
		{
			...
			{
				npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), "Process... shouldn't... be delayed... because of me..."));
