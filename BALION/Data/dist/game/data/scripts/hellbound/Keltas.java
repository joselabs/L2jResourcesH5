...
public class Keltas extends Quest
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		if (event.equalsIgnoreCase("despawn"))
		{
			...
			{
				spawnedKeltas.broadcastPacket(new CreatureSay(spawnedKeltas.getObjectId(), Say2.SHOUT, spawnedKeltas.getName(), "That is it for today...let's retreat. Everyone pull back!"));
	...
	public final String onSpawn(L2Npc npc)
	{
		if (!npc.isTeleporting())
		{
			...
			npc.broadcastPacket(new CreatureSay(spawnedKeltas.getObjectId(), Say2.SHOUT, spawnedKeltas.getName(), "Guys, show them our power!!!!"));
			spawnMinions();
	...
	public Keltas()
	{
		super(-1, Keltas.class.getSimpleName(), "hellbound");
