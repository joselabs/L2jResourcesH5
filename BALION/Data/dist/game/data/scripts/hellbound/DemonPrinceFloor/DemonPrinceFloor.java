...
public class DemonPrinceFloor extends Quest
{
	...
	{
		super(-1, DemonPrinceFloor.class.getSimpleName(), "hellbound");
		StartNpcs(GK_4, CUBE);
		TalkNpcs(GK_4, CUBE);
	...
	protected String checkConditions(L2PcInstance player)
	{
	...
	protected boolean checkTeleport(L2PcInstance player)
	{
	...
	public int enterInstance(L2PcInstance player, String template)
	{
		int instanceId = 0;
	...
	protected void setReenterTime(InstanceWorld world)
	{
		if (world instanceof DPWorld)
		{
	...
	protected void teleportPlayer(L2PcInstance player, int[] tele, int instanceId)
	{
