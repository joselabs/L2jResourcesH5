...
public class BodyDestroyer extends L2AttackableAIScript
{
	...
	{
		super(-1, BodyDestroyer.class.getSimpleName(), "hellbound");
		AttackNpcs(BDESTROYER);
		KillNpcs(BDESTROYER);
	}
	...
	public String onAttack(L2Npc npc, L2PcInstance player, int damage, boolean isPet, L2Skill skill)
	{
		...
		if (npcId == BDESTROYER)
		{
			if (_isLocked == false)
			{
				...
				npc.broadcastPacket(new CreatureSay(npc.getObjectId(), 1, npc.getName(), player.getName() + " u will Die."));
