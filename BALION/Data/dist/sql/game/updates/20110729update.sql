...
ALTER TABLE `fishing_skill_trees` ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
ALTER TABLE `mapregion` ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
ALTER TABLE `pledge_skill_trees` ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
ALTER TABLE `skill_residential` ENGINE=MyISAM DEFAULT CHARSET=utf8;
ALTER TABLE `skill_spellbooks` ENGINE=MyISAM DEFAULT CHARSET=utf8;
ALTER TABLE `skill_trees` ENGINE=MyISAM DEFAULT CHARSET=utf8;
ALTER TABLE `spawnlist` ENGINE=MyISAM DEFAULT CHARSET=utf8;
ALTER TABLE `special_skill_trees` ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
ALTER TABLE `transform_skill_trees` ENGINE=MyISAM DEFAULT CHARSET=utf8;